...
use emusrenbang\models\search\TaProgramApbnSearch;
use emusrenbang\models\search\TaKegiatanApbnSearch; 
use emusrenbang\models\TaBelanjaRincApbn;
use emusrenbang\models\TaBelanjaRincSubApbn;

use emusrenbang\models\RefUrusanApbn; //oke
use common\models\RefBidangApbn;
use emusrenbang\models\RefUnitApbn; //oke
use emusrenbang\models\RefSubUnitApbn; //oke
use emusrenbang\models\TaIndikatorApbn;

use emusrenbang\models\TaKegiatanApbn;
use emusrenbang\models\TaProgramApbn;
use yii\helpers\Json;
use emusrenbang\models\TaBelanjaApbn;
 
class PraRkaApbnController extends \yii\web\Controller
{
    ...
    public function actionBelanjaRincSub($Tahun, $Kd_Urusan, $Kd_Bidang, $Kd_Unit, $Kd_Sub, $Kd_Prog, $Kd_Keg, $Kd_Rek_1, $Kd_Rek_2, $Kd_Rek_3, $Kd_Rek_4, $Kd_Rek_5, $No_Rinc)
    {
        ...
        $data = TaBelanjaRincApbn::findOne($PosisiKegiatan);

        $data_belanja=TaBelanjaRincSubApbn::find()
    ...
    public function actionTambahRincianObyek($Tahun, $Kd_Urusan, $Kd_Bidang, $Kd_Unit, $Kd_Sub, $Kd_Prog, $Kd_Keg, $Kd_Rek_1, $Kd_Rek_2, $Kd_Rek_3, $Kd_Rek_4, $Kd_Rek_5, $No_Rinc)
    {
        ...
        $model = new TaBelanjaRincSubApbn();

        $max_id=TaBelanjaRincSubApbn::find()
                ->where($PosisiKegiatan)
                ->max('No_ID');
        $No_ID = $max_id + 1;
    ...
    public function actionHapusRincianObyek($Tahun, $Kd_Urusan, $Kd_Bidang, $Kd_Unit, $Kd_Sub, $Kd_Prog, $Kd_Keg, $Kd_Rek_1, $Kd_Rek_2, $Kd_Rek_3, $Kd_Rek_4, $Kd_Rek_5, $No_Rinc, $No_ID)
    {
      ...
      $model = TaBelanjaRincSubApbn::findOne($Posisi);
    ...
    public function actionBelanjaRinc($Tahun, $Kd_Urusan, $Kd_Bidang, $Kd_Unit, $Kd_Sub, $Kd_Prog, $Kd_Keg, $Kd_Rek_1, $Kd_Rek_2, $Kd_Rek_3, $Kd_Rek_4, $Kd_Rek_5)
    {
        ...
        $data = TaBelanjaApbn::findOne($PosisiKegiatan);

        $data_belanja = TaBelanjaRincApbn::find()->where($PosisiKegiatan)->all();
    ...
    public function actionTambahRincianSub($Tahun, $Kd_Urusan, $Kd_Bidang, $Kd_Unit, $Kd_Sub, $Kd_Prog, $Kd_Keg, $Kd_Rek_1, $Kd_Rek_2, $Kd_Rek_3, $Kd_Rek_4, $Kd_Rek_5)
    {
        ...
        $model = new TaBelanjaRincApbn();

        $max_id=TaBelanjaRincApbn::find()
                ->where($PosisiKegiatan)
                ->max('No_Rinc');
        $No_Rinc = $max_id + 1;
    ...
    public function actionHapusRincianSub($Tahun, $Kd_Urusan, $Kd_Bidang, $Kd_Unit, $Kd_Sub, $Kd_Prog, $Kd_Keg, $Kd_Rek_1, $Kd_Rek_2, $Kd_Rek_3, $Kd_Rek_4, $Kd_Rek_5, $No_Rinc)
    {
      ...
      $model = TaBelanjaRincApbn::findOne($Posisi);
    ...
    public function actionBelanja($Tahun, $Kd_Urusan, $Kd_Bidang, $Kd_Unit, $Kd_Sub, $Kd_Prog, $Kd_Keg)
    {
        ...
        $data = TaKegiatanApbn::findOne($PosisiKegiatan);

        $data_belanja = TaBelanjaApbn::find()->where($PosisiKegiatan)->all();
		$xJum=TaBelanjaRincApbn::find()->where($PosisiKegiatan)->count();
    ...
    public function actionHapusRincian($Tahun, $Kd_Urusan, $Kd_Bidang, $Kd_Unit, $Kd_Sub, $Kd_Prog, $Kd_Keg, $Kd_Rek_1, $Kd_Rek_2, $Kd_Rek_3, $Kd_Rek_4, $Kd_Rek_5)
    {
      ...
      $model = TaBelanjaApbn::findOne($Posisi);
    ...
    public function actionKegiatan($Tahun, $Kd_Urusan, $Kd_Bidang, $Kd_Unit, $Kd_Sub, $Kd_Prog)
    {
        ...
        $modelUnit = TaProgramApbn::findOne($PosisiKegiatan);

       $jlh_pagu_terpakai = TaBelanjaRincSubApbn::find()
                            ->where($PosisiKegiatan)
                           ->sum('Total');
    ...
    public function actionTambahKegiatan($Tahun, $Kd_Urusan, $Kd_Bidang, $Kd_Unit, $Kd_Sub, $Kd_Prog)
    {
        ...
        $max_id=TaKegiatanApbn::find()
                ->where($PosisiKegiatan)
                ->max('ID_Prog');
        $ID_Prog = $max_id + 1;

        $max_kd=TaKegiatanApbn::find()
                ->where($PosisiKegiatan)
                ->max('Kd_Keg');
        $Kd_Keg = $max_kd + 1;
...
$satuan =  ArrayHelper::map(RefStandardSatuan::find()->all(),'Kd_Satuan','Uraian');
    ...
    public function actionTambahKegiatan1($Tahun, $Kd_Urusan, $Kd_Bidang, $Kd_Unit, $Kd_Sub, $Kd_Prog)
    {
        $PosisiKegiatan = [
            'Tahun' => $Tahun, 
            'Kd_Urusan' => $Kd_Urusan, 
        ...
        // $model_prov = new TaKegiatanSkpdProv();
        $RefUrusanApbn =  ArrayHelper::map(RefUrusanApbn::find()->all(),'Kd_Urusan','Nm_Urusan');
        $RefBidangApbn=  [];
        $RefUnitApbn =  [];
        $RefSubUnitApbn =  [];
        ...
        return $this->renderajax('tambah-kegiatan', [
                ...
                'ref_kegiatan' => $ref_kegiatan,
                // 'model_prov' => $model_prov,
                'RefUrusanApbn' => $RefUrusanApbn,
                'RefBidangApbn' => $RefBidangApbn,
                'RefUnitApbn' => $RefUnitApbn,
                'RefSubUnitApbn' => $RefSubUnitApbn,
                //'models' => $model2,
        ]);
    }
      ...
      if($model->load($request->post())){
          ...
          try {
              ...
              foreach ($tolak_ukur as $key => $toluk) {
                $model_indikator = new TaIndikatorApbn();
    ...
    public function actionTambahKegiatanProses1()
    {
      $request = Yii::$app->request;
      $model = new TaKegiatanApbn();
      //$model_prov = new TaKegiatanSkpdProv();
    ...
    public function actionUbahKegiatan($Tahun, $Kd_Urusan, $Kd_Bidang, $Kd_Unit, $Kd_Sub, $Kd_Prog, $Kd_Keg)
    {
        ...
        $model = TaKegiatanApbn::findOne($PosisiKegiatan);
      ...
      //  $satuan =  ArrayHelper::map(Satuan::find()->all(),'id','satuan');
        ...
        $model_indikator = TaIndikatorApbn::findall($PosisiKegiatan);
    ...
    public function actionUbahKegiatanProses($Tahun, $Kd_Urusan, $Kd_Bidang, $Kd_Unit, $Kd_Sub, $Kd_Prog, $Kd_Keg)
    {
      ...
      $model = TaKegiatanApbn::findone($Posisi);
      ...
      if($model->load($request->post())){
          ...
          try {
              ...
              TaIndikatorApbn::deleteAll($Posisi);
              foreach ($tolak_ukur as $key => $toluk) {
    ...
    public function actionProgram()
    {
        ...
        $searchModel = new TaProgramApbnSearch();
        ...
        $tabelanjanrincsub = TaBelanjaRincSubApbn::find()
                          ->where($PosisiUnit)
                          ->sum('Total');
        ...
        foreach ($program as $copy) {
          ...
          $exists = TaProgramApbn::find()->where($isi)->exists();
          if(!$exists) {
            $new_prog = new TaProgramApbn();
    ...
    public function actionHasil()
    {
      ...
      $dataKegiatan = TaProgramApbn::find()->where(['Tahun'=>$TaSubUnit->Tahun ,'Kd_Urusan'=>$TaSubUnit->Kd_Urusan, 'Kd_Bidang'=>$TaSubUnit->Kd_Bidang, 'Kd_Unit'=>$TaSubUnit->Kd_Unit, 'Kd_Sub'=>$TaSubUnit->Kd_Sub])->all();
//	$datakeg=TaKegiatanApbn::find()->all()
    ...
    public function actionHasilRekap($skpd)
    {
      ...
      $dataKegiatan = TaProgramApbn::find()->where($PosisiUnit)->all();
     $xUnit=RefSubUnit::find()->where($PosisiUnit)->one();
	 //->'Nm_Sub_Unit';
	  //$xUnit=ArrayHelper::map(RefSubUnit::find()->where($PosisiUnit)->all(),'Nm_Sub_Unit','Nm_Sub_Unit');
    ...
    public function actionKirimData()
    {
      $data = [
        ...
        'data' => [
          ...
          'Ta_Belanja_Rinc_Apbn' => [
          ],
          'Ta_Belanja_Rinc_Sub_Apbn' => [
          ],
        ]
      ];

      //$data['data']['Ta_Program_Prov'][1]= ['nama'=>'padli'];
      $ta_program = TaProgramApbn::find()->all();
      $urut=0;
      foreach ($ta_program as $program) {
        $data['data']['Ta_Program_Apbn'][$urut]= [
                                      'Tahun' => $program->Tahun,
      ...
      $ta_kegiatan = TaKegiatanApbn::find()->where(['=', 'Verifikasi_Bappeda', 1])->all();
      $urut=0;
      foreach ($ta_kegiatan as $kegiatan) {
        $data['data']['Ta_Kegiatan_Apbn'][$urut]= [
      ...
      $ta_belanja = TaBelanjaApbn::find()->all();
      $urut=0;
      foreach ($ta_belanja as $belanja) {
        ...
        $data['data']['Ta_Belanja_Apbn'][$urut]= [
                                      'Tahun' => $belanja->Tahun,
      ...
      $ta_belanja_rinci_sub = TaBelanjaRincSubApbn::find()->all();
      $urut=0;
      foreach ($ta_belanja_rinci_sub as $rinc_sub) {
        if($rinc_sub->kegiatan->Verifikasi_Bappeda != 1){
          continue;
        }
        $data['data']['Ta_Belanja_Rinc_Sub_Apbn'][$urut]= [
    ...
    public function actionFormKirim()
    {
      ...
      $ta_kegiatan = TaKegiatanApbn::find()->all();
      $urut=0;
      foreach ($ta_kegiatan as $kegiatan) {
        $data['data']['Ta_Kegiatan_Apbn'][$urut]= [
                                      'Tahun' => $kegiatan->Tahun,
      ...
      return $this->render('form_kirim',['data_kirim'=>$data_kirim ]);
    }
    ...
    public function actionKirimProses()
    {
      ...
      echo "<br/>----- Program -----<br/>";
      foreach ($data_json['data']['Ta_Program_Apbn'] as $program) {
      ...
      echo "<br/>----- Kegiatan -----<br/>";
      foreach ($data_json['data']['Ta_Kegiatan_Apbn'] as $kegiatan) {
