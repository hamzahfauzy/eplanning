...
use referensi\models\search\RefKorolariSearch;
...
/**
 * RefKorolariController implements the CRUD actions for RefKorolari model.
 */
class RefKorolariController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * Lists all RefKorolari models.
     * @return mixed
     */
    public function actionIndex()
    {    
        $searchModel = new RefKorolariSearch();
    ...
    /**
     * Displays a single RefKorolari model.
    ...
    {   
        ...
        if($request->isAjax){
            ...
            return [
                    'title'=> "RefKorolari #".$Kd_Rek_1, $Kd_Rek_2, $Kd_Rek_3, $Kd_Rek_4, $Kd_Rek_5,
    ...
    /**
     * Creates a new RefKorolari model.
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Create new RefKorolari",
                    'content'=>'<span class="text-success">Create RefKorolari success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    /**
     * Updates an existing RefKorolari model.
     * For ajax request will return json object
    ...
    public function actionUpdate($Kd_Rek_1, $Kd_Rek_2, $Kd_Rek_3, $Kd_Rek_4, $Kd_Rek_5)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Update RefKorolari #".$Kd_Rek_1, $Kd_Rek_2, $Kd_Rek_3, $Kd_Rek_4, $Kd_Rek_5,
    ...
    /**
     * Delete an existing RefKorolari model.
     * For ajax request will return json object
    ...
    public function actionDelete($Kd_Rek_1, $Kd_Rek_2, $Kd_Rek_3, $Kd_Rek_4, $Kd_Rek_5)
    {
     ...
     /**
     * Delete multiple existing RefKorolari model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $Kd_Rek_1
     * @param integer $Kd_Rek_2
    ...
    /**
     * Finds the RefKorolari model based on its primary key value.
     ...
     * @param integer $Kd_Rek_4
     * @param integer $Kd_Rek_5
     * @return RefKorolari the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($Kd_Rek_1, $Kd_Rek_2, $Kd_Rek_3, $Kd_Rek_4, $Kd_Rek_5)
    {
        if (($model = RefKorolari::findOne(['Kd_Rek_1' => $Kd_Rek_1, 'Kd_Rek_2' => $Kd_Rek_2, 'Kd_Rek_3' => $Kd_Rek_3, 'Kd_Rek_4' => $Kd_Rek_4, 'Kd_Rek_5' => $Kd_Rek_5])) !== null) {
            return $model;
        } else {
