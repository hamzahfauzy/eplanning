...
<div class="ref-asb4-form">
    ...
    <?= $form->field($model, 'Kd_Asb3')->dropDownList($model->isNewRecord ? $Kd_Asb3 : $dataAsb3, ['prompt'=>'Pilih ASB3', 'id'=>'Kd_Asb3']) ?>

    <?= $form->field($model, 'Kd_Asb4')->textInput(['id' => 'Kd_Asb4']) ?>

    <?= $form->field($model, 'Nm_Asb4')->textInput(['maxlength' => true]) ?>
...
$('#Kd_Asb3').change(function(){
    ...
    $.post('index.php?r=ajax/max-asb4&Kd_Asb1='+Kd_Asb1+
                                    '&Kd_Asb2='+Kd_Asb2+
                                    '&Kd_Asb3='+Kd_Asb3+
                                    '&Kode1=<?= $model->Kd_Asb1.$model->Kd_Asb2.$model->Kd_Asb3 ?>'+'&Kode2=<?= $model->Kd_Asb4 ?>', function(data){
        $('#Kd_Asb4').val(data);
    })
})
</script>