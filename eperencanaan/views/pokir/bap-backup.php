...
<h5 style="text-align: center;">
    <b>BERITA ACARA POKIR TAHUN 2017<br></b>
</h5>
<br>
<br>
...
<p style="text-align: center;">
    Ditetapkan di Kisaran, <?php echo (date('d', $model->Waktu_Mulai) . ' ' . Yii::$app->zultanggal->ZULgetbulan(date('n', $model->Waktu_Mulai)) . ' ' . date('Y', $model->Waktu_Mulai)); ?>
</p>
</p>
...
<table style="text-align: center;width: 100%">
    ...
    <tr><td>Perwakilan Anggota DPRD</td><td>Kepala DPRD</td></tr>
    ...
    <tr><td colspan="2" > </td><td></tr>
    <tr><td >Walikota</td><td>Tim Pendamping</td></tr>
