...
class RefFraksiDprd extends \yii\db\ActiveRecord
{
    ...
    /**
     * @inheritdoc
     * @return \eperencanaan\models\query\RefFraksiDprdQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \eperencanaan\models\query\RefFraksiDprdQuery(get_called_class());
    }
}
