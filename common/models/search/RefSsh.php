...
use common\models\RefSsh as RefSshModel;

/**
 * RefSsh represents the model behind the search form of `common\models\RefSsh`.
 */
class RefSsh extends RefSshModel
{
    /**
     * @inheritdoc
     */
