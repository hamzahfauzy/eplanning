...
$this->params['breadcrumbs'][] = ['label' => 'Jenis', 'url' => ['jenis', 'id'=>$id, 'idkeg'=>$idkeg, 'rek1' => $rek1, 'rek2' => $rek2]];
...
<div class="ta-belanja-index">
    ...
    <table class='table table-bordered table-striped'>
    	...
    	<tbody>
    		<tr>
    			<td><?= $rek1.'.'.$rek2.'.'.$rek3.'.'.$d['Kd_Rek_4']; ?></td>
    			<td>
    				<?= Html::a($d['Nm_Rek_4'],
    				['rincian', 'id'=>$id, 'idkeg' => $idkeg, 'rek1' => $d['Kd_Rek_1'],
    				'rek2' => $d['Kd_Rek_2'], 'rek3' => $d['Kd_Rek_3'],
    				'rek4'=> $d['Kd_Rek_4']],
