...
<!--     <?= $form->field($model, 'Status_Usulan')->textInput() ?>
 ...
 <!--    <?= $form->field($model, 'Kd1')->textInput() ?>
    ...
    <?php ActiveForm::end(); ?>
          ...
          <!-- //  Untuk Mengambil dari  Standar //-->               
                
                <!--  <div id="satuan" style="display: none;"> 
                 <a href="#" id="asalsatuan" role="button" class="btn btn-info">Input dari Standard </a>
                 <p>
                    <?= $form->field($model, 'Kd_Asal')->dropDownList(['1' => 'SSH', '2' => 'HSPK', '3' => 'ASB'], ['prompt'=>'-Pilih Asal-', 'id'=>'Kd_Asal']) ?>

                    <?= $form->field($model, 'Kd1')->dropdownList($dataSH,['prompt'=>"Pilih Uraian 1", 'id'=>'dataSH']) ?>
                     <?= $form->field($model, 'Kd1')->dropdownList($Kd_1,['prompt'=>"Pilih Uraian 1", 'id'=>'Kd_1']) ?>
                    <?= $form->field($model, 'Kd3')->dropdownList($Kd_2,['prompt'=>"Pilih Uraian 2", 'id'=>'Kd_2']) ?> 
                    <?= $form->field($model, 'Kd4')->dropdownList($Kd_3,['prompt'=>"Pilih Uraian 3", 'id'=>'Kd_3']) ?> 
                    <?= $form->field($model, 'Kd5')->dropdownList($Kd_4,['prompt'=>"Pilih Uraian 4", 'id'=>'Kd_4']) ?> 
                    <?= $form->field($model, 'Kd6')->dropdownList($Kd_5,['prompt'=>"Pilih Uraian 5", 'id'=>'Kd_5']) ?> 
