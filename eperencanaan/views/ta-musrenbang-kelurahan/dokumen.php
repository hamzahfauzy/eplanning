...
<div class="alert alert-info">
    <strong>Silahkan Unggah Berita Acara, Absensi, Foto - Foto dan dokumen pendukung lain Musrenbang Desa/Kelurahan.</strong><br>        
        </div>
...
<?php endif; ?>
    <div class="row">
        <div class="col-md-12">
            <?= Html::a('Unduh Ulang Absen Awal', ['ta-musrenbang-kelurahan-acara/absensi', 'kode' => '1'], ['class' => 'btn btn-primary', 'target' => '_blank', 'data-toggle' => 'tooltip', 'data-placement' => 'bottom', 'title' => 'Unduh absen awal jika absen awal hilang']) ?>
			<?= Html::Button('Cetak Berita Acara', ['class' => 'btn btn-primary', 'target' => '_blank', 'data-toggle' => 'modal', 'data-target' => '#modal_info_rembuk']) ?> <!-- Add by RG -->
	    ...
	    <?php elseif ($acara->Waktu_Unduh_Berita_Acara == 0) : ?>
		 ...
		 <?= Html::Button('Cetak Berita Acara', ['class' => 'btn btn-primary', 'target' => '_blank', 'data-toggle' => 'modal', 'data-target' => '#modal_info_rembuk']) ?> <!-- Add by RG -->
               ...
               <!-- <?= Html::a('Cetak Berita Acara', ['ta-musrenbang-kelurahan-acara/berita-acara', 'kode' => '2', 'stat' => 'SELESAI'], ['class' => 'btn btn-primary', 'target' => '_blank', 'data-toggle' => 'tooltip', 'data-placement' => 'bottom', 'title' => 'Lengkapi Absensi akhir pada berita acara ini kemudian unggah kembali']) ?> //Comment By RG-->
            <?php endif; ?>
        ...
        <div class="col-md-6 col-mid-6">
            <div class="widget-container">
                <div class=" widget-block">
                    <?php $form = ActiveForm::begin(['action'=>['ta-musrenbang-kelurahan-media/unduh'],'options' => ['enctype' => 'multipart/form-data']]); ?>
                    <div class="form-group">
                        <?=
        ...
        ['class' => 'yii\grid\ActionColumn',
            ...
            'buttons' => [
                'edit1' => function ($url, $model) {
					...
					return Html::a('Hapus', ['ta-musrenbang-kelurahan-media/hapus-berkas', 'id' => $model->Kd_Media],['class' => 'btn btn-info btn-sm']);
					},
                    ],
                ],
            ],
        ...
        <div class="modal fade" id="modal_info_rembuk" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <?php $form = ActiveForm::begin(['action'=>['ta-musrenbang-kelurahan-acara/berita-acara', 'kode'=>1], 'options'=>['target' =>'_blank']]) ?>
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title" id="myModalLabel">Setting Berita Acara</h4>
                    </div>
                    <div class="modal-body">
                        <?= $form->field($acara, 'Jumlah_Peserta')->textInput(['maxlength' => true]) ?>
			<?= $form->field($acara, 'Pimpinan_Sidang')->textInput(['maxlength' => true]) ?>
			<!--<?= $form->field($acara, 'Nama_Pejabat')->textInput(['maxlength' => true]) ?> -->
			<?= $form->field($acara, 'Nomor_Berita_Acara')->textInput(['maxlength' => true]) ?>
			<?= $form->field($acara, 'Tanggal_Berita_Acara')->textInput(['maxlength' => true]) ?>
			<?= $form->field($acara, 'Sambutan_1')->textInput(['maxlength' => true]) ?>
			<?= $form->field($acara, 'Sambutan_2')->textInput(['maxlength' => true]) ?>
			<?= $form->field($acara, 'Sambutan_3')->textInput(['maxlength' => true]) ?>
			<?= $form->field($acara, 'Sambutan_4')->textInput(['maxlength' => true]) ?>
			<?= $form->field($acara, 'Sambutan_5')->textInput(['maxlength' => true]) ?>
			<?= $form->field($acara, 'Pemateri_1')->textInput(['maxlength' => true]) ?>
			<?= $form->field($acara, 'Pemateri_2')->textInput(['maxlength' => true]) ?>
			<?= $form->field($acara, 'Pemateri_3')->textInput(['maxlength' => true]) ?>
