...
/**
 * TaBelanjaApbnSearch represents the model behind the search form of `emusrenbang\models\TaBelanjaApbn`.
 */
class TaBelanjaApbnSearch extends TaBelanjaApbn
{
    /**
     * @inheritdoc
     */
