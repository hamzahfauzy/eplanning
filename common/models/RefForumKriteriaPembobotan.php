 ...
 */
class RefForumKriteriaPembobotan extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'Ref_Forum_Kriteria_Pembobotan';
    }
     ...
     */
    public function getRefForumKriteriaBobots()
    {
        return $this->hasMany(RefForumKriteriaBobot::className(), ['Kd_Kriteria' => 'Kd_Kriteria']);
    }
    ...
    {
        return new \common\models\query\RefForumKriteriaPembobotanQuery(get_called_class());
    }
}
