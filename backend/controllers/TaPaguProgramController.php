...
use backend\models\search\TaPaguProgramSearch;
...
class TaPaguProgramController extends Controller
{
    ...
    {   
        ...
        if($request->isAjax){
            ...
            return [
                    'title'=> "TaPaguProgram #".$Tahun, $Kd_Urusan, $Kd_Bidang, $Kd_Unit, $Kd_Prog,
                    'content'=>$this->renderAjax('view', [
                        'model' => $this->findModel($Tahun, $Kd_Urusan, $Kd_Bidang, $Kd_Unit, $Kd_Prog),
                    ]),
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
                            Html::a('Edit',['update','Tahun, $Kd_Urusan, $Kd_Bidang, $Kd_Unit, $Kd_Prog'=>$Tahun, $Kd_Urusan, $Kd_Bidang, $Kd_Unit, $Kd_Prog],['class'=>'btn btn-primary','role'=>'modal-remote'])
                ];    
        }else{
    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Create new TaPaguProgram",
                ...
                return [
                    ...
                    'title'=> "Create new TaPaguProgram",
                    'content'=>'<span class="text-success">Create TaPaguProgram success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    public function actionUpdate($Tahun, $Kd_Urusan, $Kd_Bidang, $Kd_Unit, $Kd_Prog)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Update TaPaguProgram #".$Tahun, $Kd_Urusan, $Kd_Bidang, $Kd_Unit, $Kd_Prog,
    ...
    /**
     * Delete an existing TaPaguProgram model.
     * For ajax request will return json object
    ...
    public function actionDelete($Tahun, $Kd_Urusan, $Kd_Bidang, $Kd_Unit, $Kd_Prog)
    {
     ...
     /**
     * Delete multiple existing TaPaguProgram model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $Tahun
     * @param integer $Kd_Urusan
