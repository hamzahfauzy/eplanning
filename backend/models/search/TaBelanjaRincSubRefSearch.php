...
/**
 * TaBelanjaRincSubRefSearch represents the model behind the search form about `backend\models\TaBelanjaRincSubRef`.
 */
class TaBelanjaRincSubRefSearch extends TaBelanjaRincSubRef
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = TaBelanjaRincSubRef::find();
