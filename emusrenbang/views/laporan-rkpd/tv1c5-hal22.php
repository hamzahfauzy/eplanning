...
<div class="box box-success">
    <div class="box-header">
        <div class="control-wrap">
          <?php $form = \yii\bootstrap\ActiveForm::begin([
                      'id' => 'search-usulan',
                      'action' => ['laporan-rkpd/cetak-tv1c5-hal22'], 
    ...
    <div class="box-header with-border">
     	<div class="col-md-1"></div><div class="col-md-10"  style="text-align:center;"><h3>Rekapitulasi Hasil Evaluasi Pelaksanaan Renja  OPD  s/d Tahun ……. (tahun berjalan) <br>Provinsi *) ……………… </h3></div><div class="col-md-1"></div>
    	<br>
