...
<div class="alert alert-info">
    <strong>Silahkan Unggah Berita Acara, Absensi, Foto - Foto dan dokumen pendukung lain.</strong><br>        
</div>
...
<?php endif; ?>
    <div class="row">
        <div class="col-md-12">
            <?= Html::a('Unduh Absen ', ['pokir/absensi', 'kode' => '2'], ['class' => 'btn btn-primary', 'target' => '_blank', 'data-toggle' => 'tooltip', 'data-placement' => 'bottom', 'title' => 'Unduh absen awal jika absen awal hilang']) ?>
<?= Html::Button('Cetak Berita Acara', ['class' => 'btn btn-primary', 'target' => '_blank', 'data-toggle' => 'modal', 'data-target' => '#modal_info_rembuk']) ?>
            ...
            <?php elseif ($acara->Waktu_Unduh_Berita_Acara == 0) : ?>
                <?= Html::Button('Cetak Berita Acara', ['class' => 'btn btn-primary', 'target' => '_blank', 'data-toggle' => 'modal', 'data-target' => '#modal_info_rembuk']) ?>
            <?php else : ?>
                <?= Html::a('Cetak Berita Acara', ['pokir/berita-acara', 'kode' => '2', 'stat' => 'SELESAI'], ['class' => 'btn btn-primary', 'target' => '_blank', 'data-toggle' => 'tooltip', 'data-placement' => 'bottom', 'title' => 'Lengkapi Absensi akhir pada berita acara ini kemudian unggah kembali']) ?>
            <?php endif; ?>
        ...
        <div class="col-md-6 col-mid-6">
            <div class="widget-container">
                <div class=" widget-block">
                    <?php $form = ActiveForm::begin(['action'=>['ta-pokir-media/unduh'],'options' => ['enctype' => 'multipart/form-data']]); ?>
            ...
            ['class' => 'yii\grid\ActionColumn',
                ...
                'buttons' => [
                    ...
                    'edit3' => function ($url, $model){
                        return Html::a('Hapus', ['ta-pokir-media/hapus-berkas', 'id' => $model->Kd_Media],['class' => 'btn btn-danger btn-sm']);
                        },
                        ],
                    ],
                ],
        ...
        <div class="modal fade" id="modal_info_rembuk" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <?php $form = ActiveForm::begin(['action'=>['ta-pokir/berita-acara', 'kode'=>1], 'options'=>['target' =>'_blank']]) ?>
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title" id="myModalLabel">Data Pelaksanaan Peserta</h4>
                    </div>
                    <div class="modal-body">
						...
						<?= $form->field($acara, 'Nomor_BA')->textInput(['maxlength' => true]) ?> 
						<?= $form->field($acara, 'Tanggal_BA')->textInput(['maxlength' => true]) ?>
                    </div>
