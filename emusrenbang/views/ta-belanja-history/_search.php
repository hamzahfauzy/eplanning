...
/* @var $model app\models\TaBelanjaHistorySearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="ta-belanja-history-search">
    ...
    <?php // echo $form->field($model, 'Nilai_Lalu') ?>

    <?php // echo $form->field($model, 'Nilai_YAD') ?>

    <?php // echo $form->field($model, 'Nilai_YAD_2') ?>

    <?php // echo $form->field($model, 'Nilai_YAD_3') ?>
