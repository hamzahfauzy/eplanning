    ...
    <div class="ref-kegiatan-index"> 
        <div class="box box-success">
            <div class="box-body">
                ...
                <hr/>
                <?php
                if (Helper::checkRoute('pra-rka-prov/tambah-kegiatan')) : ?>
            
                <button type="button" class="btn btn-success pull-right" id="btn_tambah_kegiatan" 
                    value="<?= Url::to(['pra-rka-prov/tambah-kegiatan',
                            'Tahun' => $data->Tahun,
                ...
                GridView::widget([
                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'label' => 'Aksi',
                            'value' => function($model) {
                                $url = Url::to(['pra-rka-prov/hapus-kegiatan',
                                              'Tahun' => $model->Tahun,
                                              'Kd_Urusan' => $model->Kd_Urusan,
                                              'Kd_Bidang' => $model->Kd_Bidang,
                                              'Kd_Unit' => $model->Kd_Unit,
                                ...
                                $url2 = Url::to(['pra-rka-prov/ubah-kegiatan',
                                              'Tahun' => $model->Tahun,
                                              'Kd_Urusan' => $model->Kd_Urusan,
                                              'Kd_Bidang' => $model->Kd_Bidang,
                                              'Kd_Unit' => $model->Kd_Unit,
                                ...
                                if (Helper::checkRoute('pra-rka-prov/ubah-kegiatan')) : 
                                $btn = $btn1." ".$btn2;
                                return $btn;
