        ...
        <div class="box-body">
          ...
          <div class="col-md-5">
            <table class="table table-bordered">
                ...
                <tr>
                    <td>Pemakaian Pagu Indikatif OPD</td>
                    <td>:</td>
                    <td align="right">
                        <?php 
          ...
          <div class="col-md-12">
            ...
            <hr/>
             <?php
            if (Helper::checkRoute('pra-rka/tambah-rincian-obyek')) : ?>
            <button type="button" class="btn btn-success pull-right" id="btn_tambah_rincian_obyek" 
                value="<?= Url::to(['pra-rka/tambah-rincian-obyek',
                        'Tahun' => $data->Tahun,
                        'Kd_Urusan' => $data->Kd_Urusan,
                        'Kd_Bidang' => $data->Kd_Bidang,
                        'Kd_Unit' => $data->Kd_Unit,
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                              ...
                              $lokasi = '';
                              if ($value->Lokasi != '') {
                                $lokasi = " di ".$value->Lokasi;
                              }
                              ?>

                        <!--  -->

                              <?= $value->Uraian_Asal_Biaya." : ".$value->Keterangan.$lokasi ?>
                            </td>
                            ...
                            <td>
                             <?php
                            if (Helper::checkRoute('pra-rka/hapus-rincian-obyek')) : ?>
                              <a href="#" title="Hapus" class="hapus_obyek" data-tujuan="<?= Url::to(['pra-rka/hapus-rincian-obyek',
                                                                  'Tahun' => $value->Tahun,
                                                                  'Kd_Urusan' => $value->Kd_Urusan,
                                                                  'Kd_Bidang' => $value->Kd_Bidang,
                                                                  'Kd_Unit' => $value->Kd_Unit,
                              ...
                              <?php endif;?>
                               <?php if (Helper::checkRoute('pra-rka/ubah-rincian-obyek')) : ?>
                              <a href="#" title="Ubah" class="ubah_obyek" value="<?= Url::to(['pra-rka/ubah-rincian-obyek',
                                                                  'Tahun' => $value->Tahun,
                                                                  'Kd_Urusan' => $value->Kd_Urusan,
                                                                  'Kd_Bidang' => $value->Kd_Bidang,
                                                                  'Kd_Unit' => $value->Kd_Unit,
