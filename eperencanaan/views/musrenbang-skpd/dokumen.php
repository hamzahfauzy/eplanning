...
$this->title = 'Tambah/Upload Dokumen Forum Perangkat Daerah';
...
<div class="alert alert-info">
    <strong>Silahkan Unggah Berita Acara, Absensi, Foto - Foto dan dokumen pendukung lain Forum Perangkat Daerah.</strong><br>        
</div>
...
<!--        <?= Html::a('Cetak Berita Acara', ['musrenbang-skpd-acara/berita-acara', 'kode' => '2', 'stat' => 'SELESAI'], ['class' => 'btn btn-primary', 'target' => '_blank', 'data-toggle' => 'tooltip', 'data-placement' => 'bottom', 'title' => 'Lengkapi Absensi akhir pada berita acara ini kemudian unggah kembali']) ?>			-->

	 <?php endif; ?>
            <?php if ($dataProvider->getTotalCount() !== 0) : ?>
                <?= Html::a('Unduh Semua Berkas Pendukung', ['musrenbang-skpd/himpun-semua', 'kode' => '2'], ['class' => 'btn btn-primary', 'target' => '_blank', 'data-toggle' => 'tooltip', 'data-placement' => 'bottom', 'title' => 'Jika sudah mengupload seluruh berkas diperlukan silahkan download']) ?>
            <?php endif; ?>
        </div>
    </div>
    <div class="row">
        <div class="col-md-6 col-mid-6">
            <div class="widget-container">
                <div class=" widget-block">
                    <?php $form = ActiveForm::begin(['action'=>['musrenbang-skpd-media/unduh'],'options' => ['enctype' => 'multipart/form-data']]); ?>
            ...
            ['class' => 'yii\grid\ActionColumn',
                ...
                'buttons' => [
                    ...
                    'edit3' => function ($url, $model){
                        return Html::a('Hapus', ['musrenbang-skpd-media/hapus-berkas', 'id' => $model->Kd_Media],['class' => 'btn btn-danger btn-sm']);
                        },
                        ],
                    ],
                ],
        ...
        <div class="modal fade" id="modal_info_rembuk" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <?php $form = ActiveForm::begin(['action'=>['musrenbang-skpd-acara/berita-acara', 'kode'=>1], 'options'=>['target' =>'_blank']]) ?>
                    ...
                    <div class="modal-body">
						...
						<?= $form->field($acara, 'Jadwal_Forum')->textInput(['maxlength' => true]) ?>
