    ...
    $this->title = 'Usulan Ke APBN / Kegiatan OPD';
    ...
    <div class="ref-kegiatan-index"> 
        <div class="box box-success">
            <div class="box-body">
                ...
                <hr/>
                <?php
                if (Helper::checkRoute('pra-rka-apbn/tambah-kegiatan')) : ?>
            
                <button type="button" class="btn btn-success pull-right" id="btn_tambah_kegiatan" 
                    value="<?= Url::to(['pra-rka-apbn/tambah-kegiatan',
                            'Tahun' => $data->Tahun,
                ...
                GridView::widget([
                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'label' => 'Aksi',
                            'value' => function($model) {
                                $url = Url::to(['pra-rka-apbn/hapus-kegiatan',
                                              'Tahun' => $model->Tahun,
                                              'Kd_Urusan' => $model->Kd_Urusan,
                                              'Kd_Bidang' => $model->Kd_Bidang,
                                              'Kd_Unit' => $model->Kd_Unit,
                                ...
                                $url2 = Url::to(['pra-rka-apbn/ubah-kegiatan',
                                              'Tahun' => $model->Tahun,
                                              'Kd_Urusan' => $model->Kd_Urusan,
                                              'Kd_Bidang' => $model->Kd_Bidang,
                                              'Kd_Unit' => $model->Kd_Unit,
                               ...
                               // $btn1 = '<a href="#" title="Hapus" class="hapus_kegiatan" data-tujuan="'.$url.'"><i class="fa fa-trash"></i></a>';
                                ...
                                if (Helper::checkRoute('pra-rka-apbn/ubah-kegiatan')) : 
                                    $btn = $btn1." ".$btn2;
                                    return $btn;
                                endif;
