...
<div class="ref-kegiatan-index"> 
    <div class="box box-success">
        <div class="box-body">
            ...
            <hr/>
            <?php
            if (Helper::checkRoute('pra-rka/tambah-rincian-sub')) : ?>
            <button type="button" class="btn btn-success pull-right" id="btn_tambah_rincian_sub" 
                value="<?= Url::to(['pra-rka/tambah-rincian-sub',
                        'Tahun' => $data->Tahun,
                        'Kd_Urusan' => $data->Kd_Urusan,
                        'Kd_Bidang' => $data->Kd_Bidang,
                        'Kd_Unit' => $data->Kd_Unit,
            ...
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                <?php
                    ...
                    ?>
                      <tr>
                        ...
                        <td style="text-align:right;"><?php echo number_format($value->getTaBelanjaRincSubs()->count(),0,'.','.') ?></td>
                        <td style="text-align:right;"><?= number_format($value->getTaBelanjaRincSubs()->sum('Total'),0,'.','.') ?></td>
                        <td>

                        <?php if (Helper::checkRoute('pra-rka/hapus-rincian-sub') && $value->getTaBelanjaRincSubs()->count()<=0) : ?>
                          <a href="#" title="Hapus" class="hapus_rincian_sub" data-tujuan="<?= Url::to(['pra-rka/hapus-rincian-sub',
                                                                  'Tahun' => $value->Tahun,
                                                                  'Kd_Urusan' => $value->Kd_Urusan,
                                                                  'Kd_Bidang' => $value->Kd_Bidang,
                                                                  'Kd_Unit' => $value->Kd_Unit,
                          ...
                          <?php endif; ?> 
                          <?php if (Helper::checkRoute('pra-rka/ubah-rincian-sub')) : ?>   
                          <a href="#" title="Ubah" class="ubah_rincian_sub" value="<?= Url::to(['pra-rka/ubah-rincian-sub',
                                                                  'Tahun' => $value->Tahun,
                                                                  'Kd_Urusan' => $value->Kd_Urusan,
                                                                  'Kd_Bidang' => $value->Kd_Bidang,
                                                                  'Kd_Unit' => $value->Kd_Unit,
                ...
                <tr>
                  <td></td>
                  <th>Total :</th>
                  <td style="text-align:right;"><?= number_format($jlh_objek_rincian,0,'.','.') ?></td>
                  <td style="text-align:right;"><?= number_format($jlh_pagu_terpakai,0,'.','.') ?></td>
                  <td></td>
                </tr>
              </tbody>
            </table>
