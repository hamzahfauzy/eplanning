...
use referensi\models\search\RefKamusProgramSearch;
...
class RefKamusProgramController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Create new RefKamusProgram",
                ...
                return [
                    ...
                    'title'=> "Create new RefKamusProgram",
                    'content'=>'<span class="text-success">Create RefKamusProgram success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    public function actionUpdate($id)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Update RefKamusProgram #".$id,
    ...
    /**
     * Delete an existing RefKamusProgram model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing RefKamusProgram model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
