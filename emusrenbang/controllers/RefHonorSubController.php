...
use app\models\RefHonorSubSearch;
...
class RefHonorSubController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['view', 'id' => $model->Kd_Honor_Sub]);
        } else {
    ...
    /**
     * Deletes an existing RefHonorSub model.
    ...
    {
        if (($model = RefHonorSub::findOne($id)) !== null) {
            return $model;
        } else {
