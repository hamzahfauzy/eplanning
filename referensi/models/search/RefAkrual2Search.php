...
/**
 * RefAkrual2Search represents the model behind the search form about `common\models\RefAkrual2`.
 */
class RefAkrual2Search extends RefAkrual2
{
    /**
     * @inheritdoc
     */
