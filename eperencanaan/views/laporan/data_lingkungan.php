  ...
  foreach ($data as $key => $value) {
	...
	*/
	echo "
		<tr><td colspan='2'>&nbsp;</td></tr>
		<tr>
			<td colspan='2'><button data-prov='$Kd_Prov' data-kab='$Kd_Kab' data-kec='$Kd_Kec' data-kel='$Kd_Kel' data-urutkel='$Kd_Urut' class='btn btn-primary btn-cetak-ling'>Berita Acara</button></td>
		</tr>
		<tr>
			<td colspan='2'><button data-prov='$Kd_Prov' data-kab='$Kd_Kab' data-kec='$Kd_Kec' data-kel='$Kd_Kel' data-urutkel='$Kd_Urut' class='btn btn-primary btn-cetak-usulan'>Usulan</button></td>
		</tr>
	";
?>
...
<script type="text/javascript">
	...
	$(".data-ling").click(function(){
		...
		//alert("index.php?r=laporan/getjalan&Kd_Prov="+prov+"&Kd_Kab="+kab+"&Kd_Kec="+kec+"&Kd_Kel="+urut+"&Kd_Lingkungan="+lingkungan);
		$.ajax({
	    url: "index.php?r=laporan/getjalan",
	...
	$(".data-ling").click(function(){
		...
		//alert("index.php?r=laporan/getusulan&Kd_Prov="+prov+"&Kd_Kab="+kab+"&Kd_Kec="+kec+"&Kd_Kel="+urut+"&Kd_Lingkungan="+lingkungan);
		$.ajax({
	    url: "index.php?r=laporan/getusulan",
	    data: "Kd_Prov="+prov+"&Kd_Kab="+kab+"&Kd_Kec="+kec+"&Kd_Kel="+urut+"&Kd_Lingkungan="+lingkungan,
	...
	$("#btn_hapus_lingkungan").click(function(){
		//alert(prov);
		//alert("index.php?r=laporan/hapuslingkungan"+"&Kd_Prov="+prov+"&Kd_Kab="+kab+"&Kd_Kec="+kec+"&Kd_Kel="+urut+"&Kd_Lingkungan="+lingkungan);
		//var datastring = $("#form_lingkungan_hapus").serialize();
		$.ajax({
		    type: "POST",
		    url: "index.php?r=laporan/hapuslingkungan",
	...
	$(".btn-cetak-ling").click(function(){
		var prov = $(this).data('prov');
		var kab = $(this).data('kab');
		var kec = $(this).data('kec');
		var kel = $(this).data('kel');
		var urutkel = $(this).data('urutkel');
		var win = window.open("index.php?r=laporan/cetak-berita-acara-kelurahan"+"&"+"Kd_Prov="+prov+"&Kd_Kab="+kab+"&Kd_Kec="+kec+"&Kd_Kel="+kel+"&Kd_Urut_Kel="+urutkel, '_blank');
		if (win) {
	...
	$(".btn-cetak-usulan").click(function(){
		var prov = $(this).data('prov');
		var kab = $(this).data('kab');
		var kec = $(this).data('kec');
		var kel = $(this).data('kel');
		var urutkel = $(this).data('urutkel');
		var win = window.open("index.php?r=laporan/cetak-usulan-kelurahan"+"&"+"Kd_Prov="+prov+"&Kd_Kab="+kab+"&Kd_Kec="+kec+"&Kd_Kel="+kel+"&Kd_Urut_Kel="+urutkel, '_blank');
		if (win) {
		    //Browser has allowed it to be opened
		    win.focus();
		} else {
