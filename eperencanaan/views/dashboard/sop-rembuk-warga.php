            ...
            <div class="container">
                ...
                <div class="page-title" id="tour-step-4">
                    <h1>E-Planning Kabupaten Asahan</h1>
                     <h5>Untuk Panduan Penyelenggaraan Rembuk Warga silahkan klik tombol unduh dibawah</h5>
                   </div>
                <!-- ./page title -->
                        ...
                        <div class="box-widget widget-module">
                            <div class="widget-container">
                                ...
                                <div class="form-group">
                                    ...
                                    <a href="../sop/sop-rembuk-warga.pdf" class="btn btn-success" target="_blank"><span class="fa fa-download">
