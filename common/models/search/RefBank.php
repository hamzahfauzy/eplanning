...
use common\models\RefBank as RefBankModel;

/**
 * RefBank represents the model behind the search form about `common\models\RefBank`.
 */
class RefBank extends RefBankModel
{
    /**
     * @inheritdoc
     */
