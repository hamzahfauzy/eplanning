...
$this->title = 'Referensi Rekening Objek';
            ...
            <div class="box-header">
                ...
                <?php 
                    if (Helper::checkRoute('create')) {
                        echo Html::a('Tambah Referensi Rekening Objek', ['create'], ['class' => 'btn btn-success pull-right']);
                    }
                ?>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
 			...
 			[
                        ...
                        [
                            'attribute' =>'Nm_Rek_4',
                            'format' => 'text',
                            'value' => function($model){ return $model->Kd_Rek_4.":".$model->Nm_Rek_4; }
                        ],
                        [
