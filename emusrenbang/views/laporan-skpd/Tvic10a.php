                ...
                <div class="portlet-title">
                    ...
                    <div class="control-wrap">
                        <?php $form = \yii\bootstrap\ActiveForm::begin([
                            'id' => 'search-usulan',
                              'action' => ['laporan-skpd/cetak-tvic10a'], 
	...
	<!--Perinta Lama -->						
                       ...
                       //     if ($data->getKegiatans()->count()<=0) {
                        ...
                        <tr>
                            ...
                            <td style="font-size:11px;" align="right" > <?= number_format($pagu,0, ',', '.') ?></td> <!--align="right" > <?= number_format($dataProgKegs->getBelanjaRincSubs()->sum('Total'),0, ',', '.') ?></td>-->
