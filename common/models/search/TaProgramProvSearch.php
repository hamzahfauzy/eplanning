...
/**
 * TaProgramProvSearch represents the model behind the search form of `eperencanaan\models\TaProgramProv`.
 */
class TaProgramProvSearch extends TaProgramProv
{
    /**
     * @inheritdoc
     */
    ...
    {   
        ...
        $query = TaProgramProv::find()->where(['Kd_Urusan'=>$Unit, 'Kd_Bidang'=>$Unit]);
    ...
    public function searchProgram2($params)
    {
        ...
        $query = TaProgramProv::find()->where($PosisiUnit);
