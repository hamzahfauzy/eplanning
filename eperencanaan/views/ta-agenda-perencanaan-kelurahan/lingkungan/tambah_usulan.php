        ...
        <div class="box-widget widget-module">
            <div class="widget-container">
                <div class=" widget-block">
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-3"></label>
                        <?= Html::submitButton($model->isNewRecord ? 'Simpan' : 'Ubah', ['class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-primary identitas']) ?>
                    </div>
...
function btnPilih(data){
	...
	$('#taforumlingkungan-kd_satuan option[value='+data.satuan+']').attr('selected','selected');
	$("#taforumlingkungan-jenis_usulan").val(data.nama);
