...
/**
 * RefAnalisaSubASearch represents the model behind the search form about `common\models\RefAnalisaSubA`.
 */
class RefAnalisaSubASearch extends RefAnalisaSubA
{
    /**
     * @inheritdoc
     */
