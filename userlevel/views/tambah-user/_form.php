...
$this->registerJs(
    "$('#dapil').change(function(){
        var dapil=$(this).val();
        // alert('".Yii::$app->urlManager->createUrl('ajax/getdewan')."&Kd_Dapil='+dapil);
            ...
            <div class="box-body">
                <div class="user-form">
                    <?php $form = ActiveForm::begin(); ?>
                        ...
                        <div class="form-option" id="dropFraksi" style="padding-bottom: 10px;display: none">
                            <?= $form->field($model, 'fraksi')->dropdownlist($fraksi,
                            [
                                'prompt' => 'Pilih Fraksi',
                                'class' => 'dependent-input form-control',
                                'id' => 'fraksi'
                        ...
                        <div class="form-option" id="dropKomisi" style="padding-bottom: 10px;display: none">
                            <?= $form->field($model, 'komisi')->dropdownlist($komisi,
                            [
                                'prompt' => 'Pilih Komisi',
                                'class' => 'dependent-input form-control',
                                'id' => 'komisi'
