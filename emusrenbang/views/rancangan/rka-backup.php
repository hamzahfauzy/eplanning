...
// $this->title = "Penyusunan RKA ".($tahun);
$this->title = "Rancangan Pra RKA Perangkat Daerah " .($tahun);
$this->params['breadcrumbs'][] = ['label' => 'Pra RKA', 'url' => ['rancangan/awal']];
...
<div class="row">
    <div class="col-md-12">
	<h2>Maaf!<br>Untuk Menyusun Pra RKA, RKPD telah ditetapkan dalam peraturan Bupati.</h2>
	</div>
</div>
<?php } ?>
