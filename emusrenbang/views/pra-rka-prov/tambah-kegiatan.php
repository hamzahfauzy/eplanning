...
if(isset($ubah)){
	//$aksi = ;
	$url = ['pra-rka-prov/ubah-kegiatan-proses',
				'Tahun' => $Tahun,
				'Kd_Urusan' => $Kd_Urusan,
				'Kd_Bidang' => $Kd_Bidang,
				'Kd_Unit' => $Kd_Unit,
	...
	$url = ['pra-rka-prov/tambah-kegiatan-proses'];
	$disable = false;
}
?>
<div class="misi-form">
  <?php $form = ActiveForm::begin(['action' =>$url,'id' => 'tambah_kegiatan_form']); ?>
  	...
  	<div class="col-md-12">
		...
		<div class="col-md-6">
			...
			<?= $form->field($model, 'Kd_Sumber')->dropDownList(['1'=>'Dana Bagi Hasil', '2'=>'Bantuan Keuangan Provinsi'], ['prompt'=>'Pilih Sumber', 'class'=>'form-control input-sm selects']) ?>
		...
		<div class="col-md-3">
			<?= $form->field($model, 'Kd_Urusan_Prov')->dropDownList($RefUrusanProv, ['prompt'=>'Pilih Status', 'class'=>'form-control input-sm', 'id'=>'Kd_Urusan_Prov']) ?>
		</div>
		<div class="col-md-3">
			<?= $form->field($model, 'Kd_Bidang_Prov')->dropDownList($RefBidangProv, ['prompt'=>'Pilih', 'class'=>'form-control input-sm', 'id'=>'Kd_Bidang_Prov']) ?>
		</div>
		<div class="col-md-3">
			<?= $form->field($model, 'Kd_Unit_Prov')->dropDownList($RefUnitProv, ['prompt'=>'Pilih', 'class'=>'form-control input-sm', 'id'=>'Kd_Unit_Prov']) ?>
		</div>
		<div class="col-md-3">
			<?= $form->field($model, 'Kd_Sub_Prov')->dropDownList($RefSubUnitProv, ['prompt'=>'Pilih', 'class'=>'form-control input-sm', 'id'=>'Kd_Sub_Prov']) ?>
		</div>
		<div class="clearfix"></div>
