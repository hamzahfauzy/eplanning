...
<h5 style="text-align: center;"><b>BERITA ACARA<br> HASIL KESEPAKATAN MUSRENBANG RKPD  <BR> KABUPATEN ASAHAN TAHUN <?= $tahun +1?></b>  </h5>
<br>

<p style="text-align: justify;">Pada hari Selasa sampai dengan Rabu Tanggal 12 sampai dengan 13 bulan Maret tahun dua ribu sembilan belas,
...
<table style ="width: 100%;text-align: justify;vertical-align: top;border-collapse: collapse;">
	...
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- Gubernur Sumatera Utara diwakili Bappeda Provinsi Sumatera Utara (Dr.Ir. Hasmirizal Lubis, M.Si)<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- Wakil Bupati Asahan (H. Surya, B.Sc)</td> </tr>
	</table>
	<table style ="width: 100%;text-align: justify;vertical-align: top;border-collapse: collapse;">
    <tr ><td style="padding: 4px">2. Pemaparan materi: 
	<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- Tim Pemantau dan Pengamanan Pembangunan dan Pemerintah Daerah (Essandera Aneksa, SH)<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- Bappeda Provinsi Sumatera Utara (Dr.Ir. Hasmirizal Lubis, M.Si)<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- Dinas Kesehatan Provinsi Sumatera Utara (Teguh Supriyadi, SKM, MPH)
	<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- Dinas Bina Marga dan Bina Konstruksi Provinsi Sumatera Utara (Elfian Aziz, ST)
	<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- Dinas Tanaman Pangan dan Hortikultura (Ir. Suyono, MM)
	<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- PTPN III Kebun Sei Dadap (Edy Susanto)
	<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- Kepala Dinas PUPR Kabupaten Asahan (T. Adi Huzaifah, S.Sos)
	<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- Kepala Dinas Kesehatan Kabupaten Asahan (dr. Aris Yudariansah, MM)
	<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- Kepala Dinas Pendidikan Kabupaten Asahan (Drs. Sofian, M.Pd)
	<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- Kepala Dinas Ketahanan Pangan Kabupaten Asahan (Ir. Amir Husin Siregar, MMA)
	<br>
...
<?php echo "Selasa-Rabu, 12 s/d 13 Maret 2019"//$hari.", ".$xTgl . " " . $bln ." ". $xThn;?>	
    ...
    <tr >
        <td style="padding: 4px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Waktu&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&ensp;&nbsp;:&nbsp;<?php
		   ...
		   echo "08.30 WIB s/d Selesai";//s/d Selesai";
            ?> </td> </tr>
    ...
    <tr >
        <td style="padding: 4px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Peserta&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&thinsp;&thinsp;:&nbsp;<?php echo "Hari I : 240 Orang; Hari II: 155";//(@$model->Jumlah_Peserta); ?> orang<i> (Terlampir)</i> </td> </tr>
 <!--
 <tr>
...
<br>
<p style="text-align: justify;">seluruh peserta Musrenbang RKPD Kabupaten Asahan Tahun <?= $tahun +1?>. </p>
<br>
<p style="text-align: Center;">MENYEPAKATI </p></BR>
<table style ="width: 100%;text-align: justify;vertical-align: top;border-collapse: collapse;">
    <tr ><td style="padding: 4px">KESATU : </td>
<td>Sasaran dan prioritas pembangunan daerah, serta rencana program dan kegiatan yang disertai indikator dan target kinerja dan kebutuhan pendanan dalam rancangan RKPD Kabupaten Asahan Tahun <?= $tahun +1?> sebagaimana tercantum dalam Lampiran II dan Lampiran III berita acara ini;</td>
</tr> 
<tr ><td style="padding: 4px">KEDUA : </td>
<td>Program dan kegiatan yang belum diakomodir dalam rancangan RKPD Kabupaten Asahan Tahun <?= $tahun +1?> beserta alasannya sebagaimana tercantum dalam Lampiran IV berita acara ini;</td> </tr>
<tr ><td style="padding: 4px">KETIGA : </td>
<td>Rumusan yang tercantum dalam lampiran yang merupakan bagian yang tidak terpisahkan dari hasil kesepakatan Musrenbang RKPD Kabupaten Asahan Tahun <?= $tahun +1?>  untuk dijadikan sebagai bahan penyusunan rancangan akhir RKPD Kabupaten Asahan Tahun <?= $tahun +1?>;</td> </tr>
...
<p style="text-align: left;">
 ...
 Kisaran,  <?php echo "13 Maret 2019";//date('d F Y') ;?> 
</p>
...
<br>
&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&thinsp;&thinsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&thinsp;&thinsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&thinsp;&thinsp;&emsp;&emsp;Kabupaten Asahan Tahun <?= $tahun +1?>
<br><br><br><br>
...
<pagebreak />
<p style="text-align: left;">
   Mewakili peserta musrenbang RKPD Kabupaten Asahan Tahun  <?= $tahun +1?> <!--<?php echo (@$model->sub1->Nm_Sub_Unit); ?> -->
</p>
