...
use Yii;
use backend\models\TaBelanjaHistory;
use backend\models\search\TaBelanjaHistorySearch;
...
/**
 * TaBelanjaHistoryController implements the CRUD actions for TaBelanjaHistory model.
 */
class TaBelanjaHistoryController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * Lists all TaBelanjaHistory models.
     * @return mixed
     */
    public function actionIndex()
    {    
        $searchModel = new TaBelanjaHistorySearch();
    ...
    /**
     * Displays a single TaBelanjaHistory model.
     * @param integer $Tahun
    ...
    {   
        ...
        if($request->isAjax){
            ...
            return [
                    'title'=> "TaBelanjaHistory #".$Tahun, $Kd_Urusan, $Kd_Bidang, $Kd_Unit, $Kd_Sub, $Kd_Prog, $Kd_Keg, $Kd_Rek_1, $Kd_Rek_2, $Kd_Rek_3, $Kd_Rek_4, $Kd_Rek_5,
    ...
    /**
     * Creates a new TaBelanjaHistory model.
    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Create new TaBelanjaHistory",
                ...
                return [
                    ...
                    'title'=> "Create new TaBelanjaHistory",
                    'content'=>'<span class="text-success">Create TaBelanjaHistory success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    /**
     * Updates an existing TaBelanjaHistory model.
     * For ajax request will return json object
    ...
    public function actionUpdate($Tahun, $Kd_Urusan, $Kd_Bidang, $Kd_Unit, $Kd_Sub, $Kd_Prog, $Kd_Keg, $Kd_Rek_1, $Kd_Rek_2, $Kd_Rek_3, $Kd_Rek_4, $Kd_Rek_5)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Update TaBelanjaHistory #".$Tahun, $Kd_Urusan, $Kd_Bidang, $Kd_Unit, $Kd_Sub, $Kd_Prog, $Kd_Keg, $Kd_Rek_1, $Kd_Rek_2, $Kd_Rek_3, $Kd_Rek_4, $Kd_Rek_5,
    ...
    /**
     * Delete an existing TaBelanjaHistory model.
     * For ajax request will return json object
    ...
    public function actionDelete($Tahun, $Kd_Urusan, $Kd_Bidang, $Kd_Unit, $Kd_Sub, $Kd_Prog, $Kd_Keg, $Kd_Rek_1, $Kd_Rek_2, $Kd_Rek_3, $Kd_Rek_4, $Kd_Rek_5)
    {
     ...
     /**
     * Delete multiple existing TaBelanjaHistory model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $Tahun
     * @param integer $Kd_Urusan
    ...
    /**
     * Finds the TaBelanjaHistory model based on its primary key value.
     ...
     * @param integer $Kd_Rek_4
     * @param integer $Kd_Rek_5
     * @return TaBelanjaHistory the loaded model
    ...
    {
        if (($model = TaBelanjaHistory::findOne(['Tahun' => $Tahun, 'Kd_Urusan' => $Kd_Urusan, 'Kd_Bidang' => $Kd_Bidang, 'Kd_Unit' => $Kd_Unit, 'Kd_Sub' => $Kd_Sub, 'Kd_Prog' => $Kd_Prog, 'Kd_Keg' => $Kd_Keg, 'Kd_Rek_1' => $Kd_Rek_1, 'Kd_Rek_2' => $Kd_Rek_2, 'Kd_Rek_3' => $Kd_Rek_3, 'Kd_Rek_4' => $Kd_Rek_4, 'Kd_Rek_5' => $Kd_Rek_5])) !== null) {
            return $model;
        } else {
