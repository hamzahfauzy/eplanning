...
<?php endif; ?>
    <div class="row">
        <div class="col-md-12">
			...
			<?= Html::Button('Cetak Berita Acara Awal', ['class' => 'btn btn-primary', 'target' => '_blank', 'data-toggle' => 'modal', 'data-target' => '#modal_info_rembuk']) ?> <!-- Add by RG -->
	...
	<?php elseif ($acara->Waktu_Unduh_Berita_Acara == 0) : ?>
            ...
            <?php else : ?>
		<?= Html::Button('Cetak Berita Acara', ['class' => 'btn btn-primary', 'target' => '_blank', 'data-toggle' => 'modal', 'data-target' => '#modal_info_rembuk']) ?>
            <!--    <?= Html::a('Cetak Berita Acara', ['ta-musrenbang-kecamatan-acara/berita-acara', 'kode' => '2', 'stat' => 'SELESAI'], ['class' => 'btn btn-primary', 'target' => '_blank', 'data-toggle' => 'tooltip', 'data-placement' => 'bottom', 'title' => 'Lengkapi Absensi akhir pada berita acara ini kemudian unggah kembali']) ?> //Comment By Ripin -->
            <?php endif; ?>
