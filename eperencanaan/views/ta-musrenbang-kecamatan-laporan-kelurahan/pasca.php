      ...
      <div class=" widget-block">
        <div class="control-wrap">
            <?php $form = \yii\bootstrap\ActiveForm::begin(['id' => 'search-usulan',
                'action'=>['ta-musrenbang-kelurahan-report/cetak-pasca'], 'options' => ['target' => '_blank']])?>
            <div class="form-group">
              <div class="col-sm-3">
                <label class="col-sm-4 control-label">Prioritas Pembangunan</label>
                <?= $form->field($model, 'pri_pem')->dropDownList($ZUL_lingkungan)->label(false); ?>
              </div>
              <div class="col-sm-3">
                <label class="col-sm-4 control-label">Bidang Pembangungan</label>
