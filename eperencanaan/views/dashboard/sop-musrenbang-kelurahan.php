<?php
    ...
    $this->title = "Pelaksanaan Emusrenbang Kelurahan/Desa";
            ...
            <div class="container">
                ...
                <div class="page-title" id="tour-step-4">
                    <h1>E-Planning Kabupaten Asahan</h1>
                         <h5>Untuk Panduan Penyelenggaraan Musrenbang Desa/Kelurahan silahkan klik tombol unduh dibawah</h5>
                   </div>
                <!-- ./page title -->
                        ...
                        <div class="box-widget widget-module">
                            <div class="widget-container">
                                ...
                                <div class="form-group">
                                    ...
                                    <a href="../sop/sop-musrenbang-kelurahan.pdf" class="btn btn-success" target="_blank"><span class="fa fa-download">
