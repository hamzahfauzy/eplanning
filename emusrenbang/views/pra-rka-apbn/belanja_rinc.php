    ...
    <div class="box box-success">
        <div class="box-body">
            ...
            <button type="button" class="btn btn-success pull-right" id="btn_tambah_rincian_sub" 
                value="<?= Url::to(['pra-rka-apbn/tambah-rincian-sub',
                        'Tahun' => $data->Tahun,
                        'Kd_Urusan' => $data->Kd_Urusan,
                        'Kd_Bidang' => $data->Kd_Bidang,
                        'Kd_Unit' => $data->Kd_Unit,
                ...
                <?php
                    ...
                    ?>
                      <tr>
                        ...
                        <td>
						  <?php if (Helper::checkRoute('pra-rka-apbn/hapus-rincian-sub') && $value->getTaBelanjaRincSubs()->count()<=0) : ?>
                          <a href="#" title="Hapus" class="hapus_rincian_sub" data-tujuan="<?= Url::to(['pra-rka-apbn/hapus-rincian-sub',
                                                                  'Tahun' => $value->Tahun,
                                                                  'Kd_Urusan' => $value->Kd_Urusan,
                                                                  'Kd_Bidang' => $value->Kd_Bidang,
                                                                  'Kd_Unit' => $value->Kd_Unit,
							   ...
							   <?php endif; ?> 
                          <a href="#" title="Ubah" class="ubah_rincian_sub" value="<?= Url::to(['pra-rka-apbn/ubah-rincian-sub',
                                                                  'Tahun' => $value->Tahun,
                                                                  'Kd_Urusan' => $value->Kd_Urusan,
                                                                  'Kd_Bidang' => $value->Kd_Bidang,
                                                                  'Kd_Unit' => $value->Kd_Unit,
