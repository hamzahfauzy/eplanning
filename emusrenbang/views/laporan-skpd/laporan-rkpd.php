...
<div class="box box-success">
    <div class="box-header">
        <?= Html::a('&nbsp;Cetak&nbsp;', ['cetak-laporan-rkpd', 'urusan' => $data->Kd_Urusan, 'bidang' => $data->Kd_Bidang, 'unit' => $data->Kd_Unit, 'sub' => $data->Kd_Sub, ], 
                ...
                <tbody>
                    ...
                    <?php foreach ($data->taPrograms as $key1 => $value1): ?>
                        <tr>
                            ...
                            <td><p><?= isset($value1->taRpjmdProgramPrioritas->taRpjmdPrioritasPembangunanDaerah) ? $value1->taRpjmdProgramPrioritas->taRpjmdPrioritasPembangunanDaerah->Nm_Prioritas_Pembangunan_Kota : '' ?></p></td>
                            <td><p><?= isset($value1->taRpjmdProgramPrioritas->taRpjmdSasaran) ? $value1->taRpjmdProgramPrioritas->taRpjmdSasaran->Sasaran : '' ?></p></td>
                            <td></td>
