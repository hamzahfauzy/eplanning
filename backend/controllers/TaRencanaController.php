...
use Yii;
use backend\models\TaRencana;
use backend\models\search\TaRencanaSearch;
...
/**
 * TaRencanaController implements the CRUD actions for TaRencana model.
 */
class TaRencanaController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * Lists all TaRencana models.
     * @return mixed
     */
    public function actionIndex()
    {    
        $searchModel = new TaRencanaSearch();
    ...
    /**
     * Displays a single TaRencana model.
     * @param integer $Tahun
    ...
    {   
        ...
        if($request->isAjax){
            ...
            return [
                    'title'=> "TaRencana #".$Tahun, $Kd_Urusan, $Kd_Bidang, $Kd_Unit, $Kd_Sub, $Kd_Prog, $Kd_Keg, $Kd_Rek_1, $Kd_Rek_2, $Kd_Rek_3, $Kd_Rek_4, $Kd_Rek_5,
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Create new TaRencana",
                    'content'=>'<span class="text-success">Create TaRencana success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    /**
     * Updates an existing TaRencana model.
     * For ajax request will return json object
    ...
    public function actionUpdate($Tahun, $Kd_Urusan, $Kd_Bidang, $Kd_Unit, $Kd_Sub, $Kd_Prog, $Kd_Keg, $Kd_Rek_1, $Kd_Rek_2, $Kd_Rek_3, $Kd_Rek_4, $Kd_Rek_5)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Update TaRencana #".$Tahun, $Kd_Urusan, $Kd_Bidang, $Kd_Unit, $Kd_Sub, $Kd_Prog, $Kd_Keg, $Kd_Rek_1, $Kd_Rek_2, $Kd_Rek_3, $Kd_Rek_4, $Kd_Rek_5,
    ...
    /**
     * Delete an existing TaRencana model.
     * For ajax request will return json object
    ...
    public function actionDelete($Tahun, $Kd_Urusan, $Kd_Bidang, $Kd_Unit, $Kd_Sub, $Kd_Prog, $Kd_Keg, $Kd_Rek_1, $Kd_Rek_2, $Kd_Rek_3, $Kd_Rek_4, $Kd_Rek_5)
    {
     ...
     /**
     * Delete multiple existing TaRencana model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $Tahun
     * @param integer $Kd_Urusan
    ...
    /**
     * Finds the TaRencana model based on its primary key value.
     ...
     * @param integer $Kd_Rek_4
     * @param integer $Kd_Rek_5
     * @return TaRencana the loaded model
    ...
    {
        if (($model = TaRencana::findOne(['Tahun' => $Tahun, 'Kd_Urusan' => $Kd_Urusan, 'Kd_Bidang' => $Kd_Bidang, 'Kd_Unit' => $Kd_Unit, 'Kd_Sub' => $Kd_Sub, 'Kd_Prog' => $Kd_Prog, 'Kd_Keg' => $Kd_Keg, 'Kd_Rek_1' => $Kd_Rek_1, 'Kd_Rek_2' => $Kd_Rek_2, 'Kd_Rek_3' => $Kd_Rek_3, 'Kd_Rek_4' => $Kd_Rek_4, 'Kd_Rek_5' => $Kd_Rek_5])) !== null) {
            return $model;
        } else {
