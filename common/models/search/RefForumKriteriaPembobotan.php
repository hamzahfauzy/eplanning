...
use common\models\RefForumKriteriaPembobotan as RefForumKriteriaPembobotanModel;
 ...
 */
class RefForumKriteriaPembobotan extends RefForumKriteriaPembobotanModel
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = RefForumKriteriaPembobotanModel::find();
