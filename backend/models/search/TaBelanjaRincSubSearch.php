...
/**
 * TaBelanjaRincSubSearch represents the model behind the search form about `backend\models\TaBelanjaRincSub`.
 */
class TaBelanjaRincSubSearch extends TaBelanjaRincSub
{
    /**
     * @inheritdoc
     */
