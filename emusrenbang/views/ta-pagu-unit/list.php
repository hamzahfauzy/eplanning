                ...
                <tbody>
                    ...
                    foreach ($model as $value):
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" class="form-control rg" name="pagu[<?= $value->Kd_Urusan ?>][<?= $value->Kd_Bidang ?>][<?= $value->Kd_Unit ?>]" id="data_<?= $no ?>" value="<?= number_format($value->pagu, 0, ",", ".") ?>" id="data_id">
                            </td>
                        </tr>
                        <?php
                        $no++;
