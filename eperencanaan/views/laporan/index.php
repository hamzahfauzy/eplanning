...
<div class="row">
				...
				<?php
					...
					foreach ($dataKec as $key => $value) {
						...
						echo "<tr class='kec-col'>
											...
											<td>($usulan)</td>
											<td><a href='#' title='detail' data-prov='$Kd_Prov' data-kab='$Kd_Kab' data-kec='$Kd_Kec' class='detail_kecamatan'><i class='glyphicon glyphicon-eye-open'></i></a></td>
									</tr>";
					}
				?>
			</table>
	...
	<div class="col-md-3">
		<div class="ruang-data ruang2">
			<h3>Jalan</h3>
			<table class="daftar-data" id="list-jalan"></table>
		</div>
	</div>
	<div class="col-md-3">
		<div class="ruang-data ruang2">
			<h3>Usulan Jalan</h3>
			<table class="daftar-data" id="list-usulanjalan"></table>
		</div>
	</div>
</div>
