...
/**
 * This is the model class for table "Ta_Belanja_Lanjutan".
 *
 ...
 */
class TaBelanjaLanjutan extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['Tahun', 'Kd_Urusan', 'Kd_Bidang', 'Kd_Unit', 'Kd_Sub', 'Kd_Prog', 'ID_Prog', 'Kd_Keg', 'Kd_Rek_1', 'Kd_Rek_2', 'Kd_Rek_3', 'Kd_Rek_4', 'Kd_Rek_5', 'No_Rinc', 'No_ID', 'Nilai_1', 'Nilai_2', 'Nilai_3', 'Satuan123', 'Jml_Satuan', 'Nilai_Rp', 'Total'], 'required'],
    ...
    /**
     * @inheritdoc
     * @return \backend\models\query\TaBelanjaLanjutanQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \backend\models\query\TaBelanjaLanjutanQuery(get_called_class());
    }
}
