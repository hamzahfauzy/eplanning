...
<div class="ref-kegiatan-index"> 
    <div class="box box-success">
        <div class="box-body">
            ...
            <hr/>
            <?php
            if (Helper::checkRoute('pra-rka-apbn/tambah-rincian')) : ?>
            <button type="button" class="btn btn-success pull-right" id="btn_tambah_rincian" 
                value="<?= Url::to(['pra-rka-apbn/tambah-rincian',
                        'Tahun' => $data->Tahun,
                        'Kd_Urusan' => $data->Kd_Urusan,
                        'Kd_Bidang' => $data->Kd_Bidang,
                        'Kd_Unit' => $data->Kd_Unit,
                ...
                <?php
                    ...
                    ?>
                      <tr>
                        ...
                        <?php
						//echo $xJum; echo $value->Kd_Keg; echo $value->Kd_Prog;
                        if (Helper::checkRoute('pra-rka-apbn/hapus-rincian')&&($xJum<=0)) : ?>
                          <a href="#" title="Hapus" class="hapus_rincian" data-tujuan="<?= Url::to(['pra-rka-apbn/hapus-rincian',
                                                                  'Tahun' => $value->Tahun,
                                                                  'Kd_Urusan' => $value->Kd_Urusan,
                                                                  'Kd_Bidang' => $value->Kd_Bidang,
                                                                  'Kd_Unit' => $value->Kd_Unit,
                          ...
                          <?php if (Helper::checkRoute('pra-rka-apbn/ubah-rincian')) : ?>

                          <a href="#" title="ubah" class="ubah_rincian" value="<?= Url::to(['pra-rka-apbn/ubah-rincian',
                                                                  'Tahun' => $value->Tahun,
                                                                  'Kd_Urusan' => $value->Kd_Urusan,
                                                                  'Kd_Bidang' => $value->Kd_Bidang,
                                                                  'Kd_Unit' => $value->Kd_Unit,
