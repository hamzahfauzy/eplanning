...
use Yii;
use common\models\RefAkrualRek;
use referensi\models\search\RefAkrualRekSearch;
...
/**
 * RefAkrualRekController implements the CRUD actions for RefAkrualRek model.
 */
class RefAkrualRekController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {    
        $searchModel = new RefAkrualRekSearch();
    ...
    {   
        ...
        if($request->isAjax){
            ...
            return [
                    'title'=> "RefAkrualRek #".$Kd_Rek_1, $Kd_Rek_2, $Kd_Rek_3, $Kd_Rek_4, $Kd_Rek_5,
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Create new RefAkrualRek",
                    'content'=>'<span class="text-success">Create RefAkrualRek success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    public function actionUpdate($Kd_Rek_1, $Kd_Rek_2, $Kd_Rek_3, $Kd_Rek_4, $Kd_Rek_5)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Update RefAkrualRek #".$Kd_Rek_1, $Kd_Rek_2, $Kd_Rek_3, $Kd_Rek_4, $Kd_Rek_5,
    ...
    /**
     * Delete an existing RefAkrualRek model.
     * For ajax request will return json object
    ...
    public function actionDelete($Kd_Rek_1, $Kd_Rek_2, $Kd_Rek_3, $Kd_Rek_4, $Kd_Rek_5)
    {
     ...
     /**
     * Delete multiple existing RefAkrualRek model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $Kd_Rek_1
     * @param integer $Kd_Rek_2
