...
class TaHonorStandard extends \yii\db\ActiveRecord
{
    ...
    /**
     * @inheritdoc
     * @return \backend\models\query\TaHonorStandardQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \backend\models\query\TaHonorStandardQuery(get_called_class());
    }
}
