...
<?= Html::a('Cetak Usulan', ['lingkungan/cetak-usulan'], ['class' => 'btn btn-primary ', 'target' => '_blank']) ?>
                         ...
                         <?php
                             $pesan = '<h4><span class="label label-warning">*. Lengkapi dan verifikasi data usulan dengan melakukan koreksi, melengkapi dokumen dan menentukan koordinat untuk memperkuat usulan lingkungan </span></h4>';
    ...
    foreach ($data as $key => $value) {
        ...
        if ($acara->Waktu_Selesai != 0) {
            ...
            /*
              ...
              $stat_survey = '<select class="form-control survey-btn" data-kd="'.$value['Kd_Ta_Musrenbang_Kelurahan'].'">
              <option value="5" '.$checked_belum.'>Belum</option>
              <option value="4" '.$checked_sudah.'>Sudah</option>
              </select>';
             */
            $koreksi = Html::a('Koreksi', ['ta-musrenbang-kelurahan/koreksi',
                        'Kd_Ta_Musrenbang_Kelurahan' => $value['Kd_Ta_Musrenbang_Kelurahan']
                            ], [
...
?>
                    ...
                    <!-- lingkungan/selesai -->
                                        <?= Html::a('Kirim ke Kecamatan', ['#'], ['class' => 'btn btn-success btn-lg', 'data-toggle' => 'modal', 'data-target' => '#modal_kirim_usulan']) ?>        
<?php else : ?>
