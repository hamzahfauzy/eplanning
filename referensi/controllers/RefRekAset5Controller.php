...
use referensi\models\search\RefRekAset5Search;
...
class RefRekAset5Controller extends Controller
{
    ...
    {   
        ...
        if($request->isAjax){
            ...
            return [
                    'title'=> "RefRekAset5 #".$Kd_Aset1, $Kd_Aset2, $Kd_Aset3, $Kd_Aset4,
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Create new RefRekAset5",
                    'content'=>'<span class="text-success">Create RefRekAset5 success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    public function actionUpdate($Kd_Aset1, $Kd_Aset2, $Kd_Aset3, $Kd_Aset4)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Update RefRekAset5 #".$Kd_Aset1, $Kd_Aset2, $Kd_Aset3, $Kd_Aset4,
