                 ...
                 <li>
                  ...
                  <?php $dataProgKeg = $data->kegiatans;
                        foreach ($dataProgKeg as $dataProgKegs) :
                            if (isset($v)) {
                                if ($dataProgKegs->Verifikasi_Bappeda == '' || $dataProgKegs->Verifikasi_Bappeda == '0') continue;
                            }
                   ?>
                  ...
                  <tr>
                      <td>Total</td>
                      <td></td>
                      <td style="font-size:12px;" align="right"> <?= number_format($subunit->getBelanjaProv()->sum('Total'),0, ',', '.') ?></td>
                  </tr>
                  </table>
                  </li>        
              </ul>
