...
use common\models\search\RefRekAset4Search;
...
class RefRekAset4Controller extends Controller
{
    ...
    public function actionView($Kd_Aset1, $Kd_Aset2, $Kd_Aset3, $Kd_Aset4)
    {
        ...
        if($request->isAjax){
            ...
            return [
                    'title'=> "Kode Aset 4 #".$Kd_Aset1, $Kd_Aset2, $Kd_Aset3, $Kd_Aset4,
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Tambah Kode Aset 4",
                    'content'=>'<span class="text-success">Berhasil Tambah Kode Aset 4</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    public function actionUpdate($Kd_Aset1, $Kd_Aset2, $Kd_Aset3, $Kd_Aset4)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Perbarui Kode Aset 4 #".$Kd_Aset1, $Kd_Aset2, $Kd_Aset3, $Kd_Aset4,
