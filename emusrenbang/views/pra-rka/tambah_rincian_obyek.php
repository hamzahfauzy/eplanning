...
if(isset($ubah)){
  //$aksi = ;
  $url = ['pra-rka/ubah-rincian-obyek-proses',
        'Tahun' => $Tahun,
        'Kd_Urusan' => $Kd_Urusan,
        'Kd_Bidang' => $Kd_Bidang,
        'Kd_Unit' => $Kd_Unit,
  ...
  $url = ['pra-rka/tambah-rincian-obyek-proses'];
  $disable = false;
}
?>
...
<div class="misi-form">
  ...
  <?php $form = ActiveForm::begin(['action' =>$url,'id' => 'tambah_rincian_obyek_form']); ?>
    ...
    <input type="hidden" id="id_musrenbang" name="id_musrenbang" value="">
	 <input type="hidden" id="kcmtn" name="kcmtn" value="">
    ...
    <div class="col-md-3">
      ...
      <?= $form->field($model, 'Keterangan')->textInput(['maxlength' => true, 'class'=>'form-control input-sm','readonly'=>false, 'id'=>'uraian_obyek']) ?>
      <?= $form->field($model, 'Lokasi')->textInput(['maxlength' => true, 'class'=>'form-control input-sm', 'id'=>'lokasi']) ?>
      <?= $form->field($model, 'Nilai_Rp')->textInput(['maxlength' => true, 'class'=>'form-control input-sm uang','readonly'=>true, 'id'=>'nilai_obyek']) ?>
	    <?= $form->field($model, 'Judul')->textInput(['maxlength' => true, 'class'=>'form-control input-sm','readonly'=>true, 'id'=>'judul']) ?>
		</div>
    ...
    <div class="col-md-9">
      <?php
        ...
        echo $form->field($model, 'Ref_Usulan_Rincian')->inline()->radioList($items);
      ?>
...
<div class="col-md-3">
								...
								<select  class="form-control" id="kecamatan" name="Kd_Kec">
									...
									<?php
									$model_kec = RefKecamatan::find()->where(['Kd_Prov' => 12])->andwhere(['Kd_Kab' => 9])->orderBy(["Nm_Kec"=>SORT_ASC])->all();
	...
	<div class="col-md-12">
	<div id="usulan" class="table-responsive"></div>
	</div>
    <div class="col-md-12"><hr/></div>
    <div class="col-md-8"> 
      <h4>Rincian</h4>
...
<script type="text/javascript">
  ...
  $('input:radio[name="TaBelanjaRincSub[Ref_Usulan_Rincian]"]').change(function() {
        //alert($(this).val());
		$.get("index.php?r=ta-musrenbang/usulan&asal="+$(this).val()+"&Kd_Kec="+$("#kecamatan").val(),function(response){ 
			if(response)
