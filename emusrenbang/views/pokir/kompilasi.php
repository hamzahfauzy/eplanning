...
<div class="alert alert-info">
  <h4>Silahkan melakukan Kompilasi Usulan Dusun/Lingkungan
    ...
    <i>Kompilasi Usulan berfungsi sebagai pengelompokkan usulan dusun/lingkungan.</i>          
        </div>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Usulan Lingkungan(<span id="sisa-usulan"></span>)</h4>
      </div>
          ...
          <div class="form-group">
            <div class="col-sm-3">
              <select class="form-control" id="select-lingkungan">
                <option value="0">-Lingkungan-</option>
                <?php
