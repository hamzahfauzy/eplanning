...
$this->registerJs('$("#taforumlingkungan-harga_satuan-disp").keyup(function(){
    var jumlah = $("#jumlah").val();
    var harga = $("#taforumlingkungan-harga_satuan-disp").val();
    harga = harga.replace(/\./g, "");
    harga = harga.replace(/,/g, ".");
    var total = jumlah*harga*100;
    //alert(total);
    $("#taforumlingkungan-harga_total").val(total/100);
    $("#taforumlingkungan-harga_total-disp").val(total).trigger("mask.maskMoney");
    $("#taforumlingkungan-harga_satuan").val(harga);
