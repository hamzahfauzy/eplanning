...
<?php endif; ?>
    <div class="row">
        <div class="col-md-12">
            <?= Html::a('Unduh Ulang Absen Awal', ['lingkungan/absensi', 'kode' => '1'], ['class' => 'btn btn-primary', 'target' => '_blank']) ?>
        ...
        ['class' => 'yii\grid\ActionColumn',
            ...
            'buttons' => [
                'edit1' => function ($url, $model) {
					...
					// return Html::a('Hapus', ['lingkungan/hapus-berkas', 'id' => $model->Kd_Media],['class' => 'btn btn-info btn-sm']);
					// },
                    ],
                ],
            ],
