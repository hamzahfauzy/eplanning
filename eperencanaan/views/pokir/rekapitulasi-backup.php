...
<div class="alert alert-danger">
  <h4>Sebelum melakukan pengiriman usulan ke SKPD Pastikan semua usulan sudah benar
  </h4>
...
if ($data == null) {
    ...
    foreach ($data as $key => $value) {
        ...
        if ($acara->Waktu_Selesai == 0) {
            ...
            $koordinat = '<button class="btn btn-primary kordinat-btn" data-kd="' . $value['id'] . '" data-lat="' . $value['Latitute'] . '" data-lng="' . $value['Longitude'] . '">Koordinat</button>';

            //$riwayat = '<button class="btn btn-success ">Riwayat</button>';

            $lihatriwayat = '<button class="btn btn-success btn_lihat_riwayat" data-kode2="' . $value['id'] . '">Riwayat</button>';

            $lihatdokumen = '<button class="btn btn-success btn_lihat_dokumen" data-kode="' . $value['id'] . '">Lihat Dokumen</button>';
             $editusulan = '<a href="index.php?r=pokir/ubah&Kd_Ta_Musrenbang_Kelurahan='.$kode_usulan.'" class="btn btn-primary">Ubah</a> <a href="index.php?r=pokir/hapus&Kd_Ta_Musrenbang_Kelurahan='.$kode_usulan.'" class="btn btn-danger">Hapus</a>';
        }
        ...
        echo '
                        <tr>
                          ...
                          <td>'.$value->kelurahan['Nm_Kel'].', '.$value->kecamatan['Nm_Kec'].'
                          </td>
                          <td>
...
?>
                                    ...
                                    <?php if ($acara->Waktu_Selesai != 0) : ?>
                                        ...
                                        <?= Html::a('Kirim ke SKPD', ['#'], ['class' => 'btn btn-success btn-lg ', 'data-toggle' => 'modal','tooltip', 'data-target' => '#modal_kirim_usulan', 'data-placement' => 'bottom', 'title' => 'Pastikan seluruh usulan sudah diverifikasi dan dikompilasi','disabled' => 'disabled']) ?>
                                         <?php else : ?>
                                         
                                        <?= Html::a('Kirim ke SKPD', ['#'], ['class' => 'btn btn-success btn-lg ', 'data-toggle' => 'modal','tooltip', 'data-target' => '#modal_kirim_usulan', 'data-placement' => 'bottom', 'title' => 'Pastikan seluruh usulan sudah diverifikasi dan dikompilasi']) ?>
                <?php endif; ?>
