...
use common\models\search\RefProvinsi as RefProvinsiSearch;
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                ...
                $NASKd_Prov = RefProvinsi::find()
                    ->max('Kd_Prov');

                $Kd_Prov = $NASKd_Prov+1;
                ...
                return [
                    ...
                    'title'=> "Tambah Provinsi",
                    'content'=>'<span class="text-success">Tambah Provinsi Sukses</span>',
                    'footer'=> Html::button('Tutup',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
            ...
            */
            if ($model->load($request->post()) && $model->save()) {
                return $this->redirect(['view', '$id' => $model->Kd_Prov]);
            } else {
