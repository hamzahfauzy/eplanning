...
use emonev\models\Pages;
use emonev\models\Programs;
use emonev\models\Kegiatans;
use emonev\models\DetailKegiatan;
use emonev\models\UraianKegiatan;
use emonev\models\News;
use emonev\models\Savelog;
use emonev\models\User;
use common\models\TaSubUnit;
use common\models\TaProgram;
use common\models\RefSubUnit;
use emonev\models\TaPaguProgram;
use common\models\TaKegiatan;
use eperencanaan\models\TaMusrenbang;
use emonev\models\TaBelanja;
    ...
    public function behaviors() {
        return [
            'access' => [
                ...
                'rules' => [
                    [
                        'actions' => ['home', 'login', 'error', 'contact', 'coba'],
                        'allow' => true,
                    ],
                    [
