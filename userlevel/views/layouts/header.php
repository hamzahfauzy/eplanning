...
<header class="main-header">
    ...
    <nav class="navbar navbar-static-top" role="navigation">
        ...
        <div class="navbar-custom-menu">
			...
			<!--<img class="user-image" src="/eperencanaan/userlevel/web/images/logo.png" alt="User Image"> -->

                        <?= yii\helpers\Html::img('@web/img/user-icon.png',['alt'=>'User Image', 'class'=>'user-image']);?>
