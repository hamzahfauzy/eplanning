<div class="modal-dialog modal-lg" role="document">
  <div class="modal-content">
    ...
    <div class="modal-body">
      ...
      <div>
        <form class="form-horizontal" id="form-terima">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <textarea id="keterangan-diterima" class="form-control" name="Keterangan" rows="3"></textarea>
            </div>
          </div>
        </form>
      </div>
...
<script type="text/javascript">
  $("#btn-simpan-terima").click(function(){
    var keterangan = $("#form-terima textarea").val();
