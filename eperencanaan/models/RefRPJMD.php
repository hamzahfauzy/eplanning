 ...
 */
class RefRPJMD extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * @inheritdoc
     * @return \eperencanaan\models\query\RefRPJMDQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \eperencanaan\models\query\RefRPJMDQuery(get_called_class());
    }
}
