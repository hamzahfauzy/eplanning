...
$this->title = "Laporan RKPD Tahun " .($tahun+1);
            ...
            <div class="portlet box blue-hoki">
                <div class="portlet-title">
                    ...
                    <div class="control-wrap">
                        <div class="form-group">
                            <div class="col-sm-2">
                                <br>
                               <?= Html::a('Cetak', ['/laporan-bappeda/cetak-tvic10all'], ['class'=>'btn btn-bg btn-primary', 'target'=>'_blank']) ?>
                ...
                <div class="box-body">
                        ...
                        <caption class="headerFox text-center">
                            <h3>Rencana Program dan Kegiatan Prioritas Daerah Tahun <?= $tahun +1 ?> <br>Kabupaten Asahan</h3>
                        </caption>
                        <thead>
                                <tr>
