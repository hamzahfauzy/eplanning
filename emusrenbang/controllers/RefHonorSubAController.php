...
use app\models\RefHonorSubASearch;
...
class RefHonorSubAController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['view', 'id' => $model->Kd_Honor_Sub_A]);
        } else {
    ...
    /**
     * Deletes an existing RefHonorSubA model.
    ...
    {
        if (($model = RefHonorSubA::findOne($id)) !== null) {
            return $model;
        } else {
