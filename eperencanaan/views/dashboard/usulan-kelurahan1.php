							...
							<table id="example" class="table table-bordered table-striped">
								...
								?>
									<tr>
										...
										<td><button class="btn btn-success" onclick="showmodaldokumen(<?=$rows["Kd_Ta_Musrenbang_Kelurahan"];?>);"><span class="glyphicon glyphicon-folder-close"></span> Dokumen</button></td>
									</tr>
								<?php $no++; endforeach; ?>
								</tbody>
							</table>
