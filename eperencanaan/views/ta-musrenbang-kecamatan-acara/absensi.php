...
<h3 style="text-align: center; text-transform: uppercase;">Daftar Hadir <!--<?php echo $stat ?> --><br>Musrenbang Kecamatan <?= $Nm_Pemda?> <br>Tahun <?= $Tahun ?>
</h3>
...
<?php
$jumlah = ($model->Jumlah_Peserta==0) ? 200 : $model->Jumlah_Peserta;
for ($x = 1; $x <= $jumlah; $x++) {
...
<table style="text-align: center;">
    ...
    <tr><td> </td><td style="width: 200px">Camat <?php echo $model->kdKec->Nm_Kec; ?></td><td>
