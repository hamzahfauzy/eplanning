...
use common\models\search\RefForumKriteriaPembobotanSearch;
use common\models\RefForumKriteriaBobot;
 ...
 */
class RefForumKriteriaPembobotanController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {    
        $searchModel = new RefForumKriteriaPembobotanSearch();
    ...
    {   
        ...
        if($request->isAjax){
            ...
            return [
                    'title'=> "RefForumKriteriaPembobotan #".$id,
    ...
    {
        $request = Yii::$app->request;
        $model = new RefForumKriteriaPembobotan();
        $dataBobot = [];
        if($request->isAjax){
            /*
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Create new RefForumKriteriaPembobotan",
                ...
                try {
                    ...
                    foreach ($range as $key => $value) {
                        ...
                        $bobot = new RefForumKriteriaBobot();
                ...
                return [
                    ...
                    'title'=> "Create new RefForumKriteriaPembobotan",
                    'content'=>'<span class="text-success">Create RefForumKriteriaPembobotan success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    public function actionUpdate($id)
    {
        $request = Yii::$app->request;
        $model = $this->findModel($id);
        $dataBobot = RefForumKriteriaBobot::find()
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Update RefForumKriteriaPembobotan #".$id,
                ...
                $transaction = $connection->beginTransaction();
                try {
                    RefForumKriteriaBobot::deleteAll(['Kd_Kriteria' => $model->Kd_Kriteria]);
                    $model->save();
                    $Kd_Kriteria = $model->Kd_Kriteria;
    ...
    {
        if (($model = RefForumKriteriaPembobotan::findOne($id)) !== null) {
            return $model;
        } else {
