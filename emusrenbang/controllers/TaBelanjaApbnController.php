...
use emusrenbang\models\search\TaBelanjaApbnSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * TaBelanjaApbnController implements the CRUD actions for TaBelanjaApbn model.
 */
class TaBelanjaApbnController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * Lists all TaBelanjaApbn models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new TaBelanjaApbnSearch();
    ...
    /**
     * Displays a single TaBelanjaApbn model.
     * @param string $Tahun
    ...
    /**
     * Creates a new TaBelanjaApbn model.
    ...
    /**
     * Updates an existing TaBelanjaApbn model.
    ...
    /**
     * Deletes an existing TaBelanjaApbn model.
    ...
    /**
     * Finds the TaBelanjaApbn model based on its primary key value.
     ...
     * @param integer $Kd_Rek_4
     * @param integer $Kd_Rek_5
     * @return TaBelanjaApbn the loaded model
    ...
    {
        if (($model = TaBelanjaApbn::findOne(['Tahun' => $Tahun, 'Kd_Urusan' => $Kd_Urusan, 'Kd_Bidang' => $Kd_Bidang, 'Kd_Unit' => $Kd_Unit, 'Kd_Sub' => $Kd_Sub, 'Kd_Prog' => $Kd_Prog, 'Kd_Keg' => $Kd_Keg, 'Kd_Rek_1' => $Kd_Rek_1, 'Kd_Rek_2' => $Kd_Rek_2, 'Kd_Rek_3' => $Kd_Rek_3, 'Kd_Rek_4' => $Kd_Rek_4, 'Kd_Rek_5' => $Kd_Rek_5])) !== null) {
            return $model;
        } else {
