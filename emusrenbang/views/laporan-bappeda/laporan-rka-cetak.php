...
<table width="100%" style="border-collapse: collapse">
    ...
    <tr>
        <td style="border: 1px solid black;"><center>Pemerintahan Kabupaten Asahan <br> Tahun Anggaran : <?= $data->Tahun ?></center></td>
    </tr>
</table>
                            ...
                            <?php foreach ($value_5->getKdRek6s()->groupBy('Kd_Rek_1,Kd_Rek_2,Kd_Rek_3,Kd_Rek_4,Kd_Rek_5,No_Rinc')->select('*,sum(Total) as jumlah')->all() as $key_6 => $value_6): ?>
                                ...
                                <?php foreach ($value_6->getKdRek7s()->groupBy('Kd_Rek_1,Kd_Rek_2,Kd_Rek_3,Kd_Rek_4,Kd_Rek_5,No_Rinc,No_ID')->all() as $key_7 => $value_7): ?>
                                    <tr>
                                        ...
                                        <td style="border-right: 1px solid black;border-left: 1px solid black;border-bottom: 1px solid black;padding:4px;padding-left:32px;"><strong>- </strong><?= @$value_7->Keterangan ?></td>
