...
use common\models\RefKorolari as RefKorolariModel;

/**
 * RefKorolari represents the model behind the search form about `common\models\RefKorolari`.
 */
class RefKorolari extends RefKorolariModel
{
    /**
     * @inheritdoc
     */
