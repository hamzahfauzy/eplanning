...
/**
 * RefJabatanSearch represents the model behind the search form about `common\models\RefJabatanStruktural`.
 */
class RefJabatanSearch extends RefJabatanStruktural
{
    /**
     * @inheritdoc
     */
