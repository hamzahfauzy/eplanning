...
/**
 * RefAnalisaSubSearch represents the model behind the search form about `common\models\RefAnalisaSub`.
 */
class RefAnalisaSubSearch extends RefAnalisaSub
{
    /**
     * @inheritdoc
     */
