...
<?php if (Yii::$app->request->get('status') == 'edit'): ?>
		<div class="alert alert-info">
            <?php echo ('Nama Kecamatan : <b>'.$ZULkec.'</b><br>Nama Kelurahan :   <b>'.$ZULkel.'</b><br>Nama Lingkungan : <b>'.$ZULlin.'</b>');?>
        </div>
<?php endif; ?>
...
<?php if (Yii::$app->session->hasFlash('contactFormSubmitted')): ?>
    ...
    <?php $form = ActiveForm::begin(); ?>
		<?= $form->field($model, 'opt')->radioList(['1'=>'Provinsi', '2'=>'Kab/Kota'],['id' => 'opt']); ?>
		...
		*/
        ...
        <div class="form-group">
            ...
            <?= Html::submitButton('Pokir', ['class' => 'btn btn-primary', 'name' => 'pokir']) ?>
