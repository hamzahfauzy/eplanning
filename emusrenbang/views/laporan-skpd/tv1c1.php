...
<div class="box box-success">
    <div class="box-header">
        <?= Html::a('&nbsp;Cetak&nbsp;', ['/laporan-skpd/tv1c1-cetak'], 
                ['class' => 'btn btn-primary btn-lg', 'target' => '_blank']);
        ?>
    </div>
    <div class="box-header with-border">
     	<div class="col-md-1"></div><div class="col-md-10" style="text-align:center;"><h3>Penggabungan Prioritas Masukan Masyarakat <br> dengan Rancangan Renja <?= $TaSubUnit->kdSubUnit->Nm_Sub_Unit ?> <br> <?= $kelompok['Kab'] ?> Tahun  <?= $tahun ?></h3></div><div class="col-md-1"></div>
    	<br>
