...
<div class="box box-success">
    <div class="box-header">
        <div class="control-wrap">
          <?php $form = \yii\bootstrap\ActiveForm::begin([
                      'id' => 'search-usulan',
                      'action' => ['laporan-rkpd/cetak-tv1c4-hal19'], 
    ...
    <div class="box-header with-border">
     	<div class="col-md-1"></div><div class="col-md-10"  style="text-align:center;"><h3>Pencapaian Kinerja Pelayanan OPD Tenagakerja <br> Provinsi/Kabupaten/Kota …………**)  </h3></div><div class="col-md-1"></div>
    	<br>
    	<div class="col-xs-12">
