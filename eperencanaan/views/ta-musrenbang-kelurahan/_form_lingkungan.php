...
function btnPilih(data){
	...
	$('#takelurahanverifikasiusulanlingkungan-kd_satuan option[value='+data.satuan+']').attr('selected','selected');
	$("#takelurahanverifikasiusulanlingkungan-jenis_usulan").val(data.nama);
