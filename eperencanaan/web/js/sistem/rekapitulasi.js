...
$(".btn_ubah").click(function(){
  ...
  $.ajax({
    url: "index.php?r=ta-musrenbang-kelurahan/cekdokumen",
    data: "kode="+kode,
...
$("#survey_selesai").click(function(){
  ...
  $.ajax({
    url: "index.php?r=ta-musrenbang-kelurahan/ubahstatus",
...
$(".btn_lihat_dokumen").click(function(){
  ...
  //alert("index.php?r=ta-musrenbang-kelurahan/lihatdokumen&".'kode='+kode);
  $.ajax({
    url: "index.php?r=ta-musrenbang-kelurahan/lihatdokumen",
    data: 'kode='+kode,
...
$(".btn_lihat_riwayat").click(function(){
  ...
  $.ajax({
    url: "index.php?r=ta-musrenbang-kelurahan/lihatriwayat",
    data: 'kode2='+kode2,
