...
$this->title = 'Belanja Langsung Rincian';
...
<!-- <table class='table'>
	...
	<tr>
		...
		<td>: <?=$modelBelanja['Kd_Rek_1'].'.'.$modelBelanja['Kd_Rek_2'].'.'.$modelBelanja['Kd_Rek_3'].'.'.$modelBelanja['Kd_Rek_4'].'.'.$modelBelanja['Kd_Rek_5'].' '.$modelBelanja['Nm_Rek_5']?></td>
	</tr>
</table> -->
    ...
    ?>
<p>
<?= Html::a('Tambah', ['tambahrinc', 'id'=>$id, 'idkeg'=>$idkeg, 'rek1'=>$rek1, 'rek2'=>$rek2, 'rek3'=>$rek3, 'rek4'=>$rek4, 'rek5'=>$rek5], ['class' => 'btn btn-success']) ?>
</p>
<?php
}
?>
    <table class='table table-bordered table-striped'>
    	...
    	<tbody>
    		<tr>
    			<td class="col-md-2"><?=$modelBelanja['Kd_Rek_1'].'.'.$modelBelanja['Kd_Rek_2'].'.'.$modelBelanja['Kd_Rek_3'].'.'.$modelBelanja['Kd_Rek_4'].'.'.$modelBelanja['Kd_Rek_5'].'.'.$d['No_Rinc']; ?></td>
    			<td>
    				<?= Html::a($d['Keterangan'],
    					['listbelanjarincsub',
                            'id'=>$d['Kd_Prog'],
