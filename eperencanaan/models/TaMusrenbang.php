...
class TaMusrenbang extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['Tahun', 'Kd_Prov', 'Kd_Kec','Nm_Permasalahan', 'Jenis_Usulan', 'Jumlah', 'Kd_Satuan', 'Harga_Satuan', 'Harga_Total', 'Tanggal', 'Kd_User','Kd_Pem','Kd_Prioritas_Pembangunan_Daerah','Detail_Lokasi'], 'required'],
            [['Tahun'], 'safe'],
            [['Kd_Prov', 'Kd_Kab', 'Kd_Kec', 
			'Kd_Kel', 'Kd_Urut_Kel', 'Kd_Lingkungan', 'Kd_Jalan', 
			'Kd_Dapil', 'Kd_Dewan',  
			'Kd_Jalan', 'Kd_Urusan', 'Kd_Bidang', 'Kd_Unit', 'Kd_Sub', 
			'Kd_Prog', 'Kd_Keg', 'Kd_Pem', 'Kd_Klasifikasi', 'Jumlah', 'Kd_Satuan', 'Kd_Sasaran', 'Tanggal', 'status', 'Status_Survey', 'Kd_Prioritas_Pembangunan_Daerah', 'Status_Usulan', 'Kd_User', 'Kd1', 'Kd2', 'Kd3', 'Kd4', 'Kd5', 'Kd6', 'Kd_Kamus_Usulan'], 'string'],
            [['Nm_Permasalahan', 'Jenis_Usulan', 'Detail_Lokasi', 'Rincian_Skor', 'Status_Penerimaan_Kelurahan', 'Alasan_Kelurahan', 'Status_Penerimaan_Kecamatan', 'Alasan_Kecamatan', 'Status_Penerimaan_Skpd', 'Alasan_Skpd', 'Status_Penerimaan_Kota', 'Alasan_Kota', 'Kd_Asal', 'Uraian_Usulan', 'Kd_Asal_Usulan', 'Status_Prioritas', 'Urutan_Prioritas', 'Def_Operasional','Kd_Kamus_Usulan'], 'string'],
    ...
    'id' => 'ID',
            ...
            'Status_Penerimaan_Skpd' => 'Status  Penerimaan  OPD',
            'Alasan_Skpd' => 'Alasan  OPD',
            'Status_Penerimaan_Kota' => 'Status  Penerimaan  Kabupaten',
            'Alasan_Kota' => 'Alasan  Kabupaten',
            'Kd_User' => 'Kd  User',
            'Kd_Asal' => 'Kd  Asal',
            'Kd1' => 'Kd1',
            'Kd2' => 'Kd2',
            ...
            'Def_Operasional' => 'Definisi  Operasional',
    ...
    public function getProgram() {
        return $this->hasOne(TaProgram::className(), ['Kd_Urusan' => 'Kd_Urusan', 'Kd_Bidang' => 'Kd_Bidang', 'Kd_Unit' => 'Kd_Unit', 'Kd_Sub' => 'Kd_Sub', 'Kd_Prog' => 'Kd_Prog']);
    }
	...
	public function getRpjmdx() {
        return $this->hasOne(RefRPJMD::className(), ['Kd_Prioritas_Pembangunan_Kota' => 'Kd_Prioritas_Pembangunan_Daerah']);
    }
    /**
     * @return \yii\db\ActiveQuery
     */
    ...
    public function getkegiatan() {
        return $this->hasOne(TaKegiatan::className(), ['Kd_Urusan' => 'Kd_Urusan', 'Kd_Bidang' => 'Kd_Bidang', 'Kd_Unit' => 'Kd_Unit', 'Kd_Sub' => 'Kd_Sub', 'Kd_Prog' => 'Kd_Prog', 'Kd_Keg' => 'Kd_Keg']);
    }
	
	public function getKegiatans() {
        return $this->hasMany(TaKegiatan::className(), ['Kd_Urusan' => 'Kd_Urusan', 'Kd_Bidang' => 'Kd_Bidang', 'Kd_Unit' => 'Kd_Unit', 'Kd_Sub' => 'Kd_Sub', 'Kd_Prog' => 'Kd_Prog']);
    }
    ...
    public function getTaForumLingkungan() {
        return $this->hasOne(TaForumLingkungan::className(), [
            'Tahun' => 'Tahun', 
            'Kd_Prov' => 'Kd_Prov', 
            'Kd_Kab' => 'Kd_Kab', 
            'Kd_Kec' => 'Kd_Kec', 
    ...
    public function getTaMusrenbangKelurahan() {
        return $this->hasOne(TaMusrenbangKelurahan::className(), [
            'Tahun' => 'Tahun', 
            'Kd_Prov' => 'Kd_Prov', 
            'Kd_Kab' => 'Kd_Kab', 
            'Kd_Kec' => 'Kd_Kec', 
    ...
    public function getTaPokirAcara() {
        return $this->hasOne(TaPokirAcara::className(), ['Kd_User'=>'Kd_User']);
    }
    ...
    public function getTaPokirMedia()
    {

        return $this->hasOne(TaPokirMedia::className(), [
            'Tahun' => 'Tahun', 
            'Kd_User' => 'Kd_User', 
           ]);
