 ...
 */
class RefRpjmdController extends Controller
{
    /**
     * @inheritdoc
     */
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Create new RefRpjmd",
                    'content'=>'<span class="text-success">Create RefRpjmd success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    public function actionUpdate($Tahun, $Kd_Prov, $Kd_Kab, $Kd_Prioritas_Pembangunan_Kota)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Update RefRpjmd #".$Tahun, $Kd_Prov, $Kd_Kab, $Kd_Prioritas_Pembangunan_Kota,
    ...
    {
        if (($model = RefRpjmd::findOne(['Tahun' => $Tahun, 'Kd_Prov' => $Kd_Prov, 'Kd_Kab' => $Kd_Kab, 'Kd_Prioritas_Pembangunan_Kota' => $Kd_Prioritas_Pembangunan_Kota])) !== null) {
            return $model;
        } else {
