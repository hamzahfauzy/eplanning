...
class TaBelanjaHistory extends \yii\db\ActiveRecord
{
    ...
    /**
     * @inheritdoc
     * @return \backend\models\query\TaBelanjaHistoryQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \backend\models\query\TaBelanjaHistoryQuery(get_called_class());
    }
}
