...
<div class="box box-success">
    ...
    <div class="box-header with-border">
        <div class="col-md-1"></div><div class="col-md-10" style="text-align:center;"><h3>Kajian Usulan Program dan Kegiatan dari Kabupaten Asahan Tahun <?= date('Y') ?> <br> Provinsi <?= @$kelompok->kdProv->Nm_Prov ?></h3></div><div class="col-md-1"></div>
        <br>
