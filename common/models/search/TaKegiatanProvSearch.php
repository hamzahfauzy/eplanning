...
/**
 * TaKegiatanProvSearch represents the model behind the search form of `eperencanaan\models\TaKegiatanProv`.
 */
class TaKegiatanProvSearch extends TaKegiatanProv
{
    /**
     * @inheritdoc
     */
    ...
    //     $query =TaKegiatanProv::find()->where(['Kd_Urusan'=>$urusan, 'Kd_Bidang'=>$bidang, 'Kd_Prog'=>$id]);
    ...
    public function searchKegiatan($PosisiKegiatan)
    {
        ...
        $query =TaKegiatanProv::find()->where($PosisiKegiatan);
