...
use common\models\RefAkrual3 as RefAkrual3Model;

/**
 * RefAkrual3 represents the model behind the search form about `common\models\RefAkrual3`.
 */
class RefAkrual3 extends RefAkrual3Model
{
    /**
     * @inheritdoc
     */
