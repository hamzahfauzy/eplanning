...
?>
<h4 style="text-align: center;"><b>BERITA ACARA<br> HASIL KESEPAKATAN MUSRENBANG RKPD <BR> KABUPATEN ASAHAN <BR> <br>
        
        DI KECAMATAN <?php echo strtoupper($model->kdKec->Nm_Kec); ?> TAHUN <?= $Tahun ?></b>  </h4>
<br>
<br>
<p style="text-align: justify;">Pada hari   <?=$tanggal(date("Y-m-d"),true);?>
<!--
...
bertempat di <?php echo $model->Alamat; ?> Kecamatan  <?php echo ($model->kdKec->Nm_Kec); ?> telah diselenggarakan musrenbang dokumen rencana daerah Kabupaten Asahan yang dihadiri pemangku kepentingan sesuai dengan daftar hadir peserta yang tercantum
...
<table style ="width: 100%;text-align: justify;vertical-align: top;border-collapse: collapse;">
	...
	<td> Tanggapan dan saran dari seluruh peserta musrenbang kecamatan terhadap materi yang dipaparkan oleh masing-masing ketua kelompok diskusi sebagaimana telah dirangkum menjadi hasil keputusan kelompok diskusi musrenbang kecamatan, maka pada:
</td>
</tr></table>
<table style ="width: 100%;text-align: justify;vertical-align: top;border-collapse: collapse;">
 ...
 <tr >
        <td style="padding: 4px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Musrenbang Kecamatan &nbsp;&emsp;&thinsp;&thinsp;:&nbsp;<?php echo ($model->kdKec->Nm_Kec); ?></td> </tr>
...
<td>Kegiatan Prioritas, Sasaran, yang disertai target dan kebutuhan pendanaan dalam Daftar Prioritas Kecamatan  <?php echo ($model->kdKec->Nm_Kec) ; ?> Kabupaten Asahan Tahun <?= $Tahun+1 ?> sebagaimana tercantum dalam LAMPIRAN II berita acara ini.			</td> </tr>
...
<td>Hasil kesepakatan sidang-sidang kelompok Musrenbang Kecamatan  <?php echo ($model->kdKec->Nm_Kec); ?> Kabupaten Asahan Tahun <?= $Tahun+1 ?> Dan Daftar Hadir Peserta Musrenbang sebagaimana tercantum dalam Lampiran IV merupakan satu kesatuan dan merupakan bagian yang tidak terpisahkan dari berita ini.</td> </tr>
...
<p style="text-align: left;">
 <?php echo strtoupper($model->kdKec->Nm_Kec); ?>, <?php echo date('d F Y') ;?>  <!-- <?php echo (date('d', $model->Waktu_Selesai) . ' ' . Yii::$app->zultanggal->ZULgetbulan(date('n', $model->Waktu_Selesai)) . ' ' . date('Y', $model->Waktu_Selesai)); ?> -->
</p>
...
<pagebreak />
<h4 style="text-align: center;">Mewakili Peserta Musrenbang</h4>
