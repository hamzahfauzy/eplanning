...
<div class="ref-kegiatan-index"> 
    <div class="box box-success">
        <div class="box-body">
            ...
            <hr/>
            <?php
            if (Helper::checkRoute('pra-rka/tambah-rincian')) : ?>
            <button type="button" class="btn btn-success pull-right" id="btn_tambah_rincian" 
                value="<?= Url::to(['pra-rka/tambah-rincian',
                        'Tahun' => $data->Tahun,
                        'Kd_Urusan' => $data->Kd_Urusan,
                        'Kd_Bidang' => $data->Kd_Bidang,
                        'Kd_Unit' => $data->Kd_Unit,
                    ...
                    ?>
                      <tr>
                        ...
                        <td style="text-align:right;">
                          <?= number_format($value->getTaBelanjaRincSubs()->sum('Total'),0,'.','.') ?>
                        </td>
                        <td>

                        <?php
                        if (Helper::checkRoute('pra-rka/hapus-rincian') && $value->getTaBelanjaRincs()->count()<=0) : ?>
                          <a href="#" title="Hapus" class="hapus_rincian" data-tujuan="<?= Url::to(['pra-rka/hapus-rincian',
                                                                  'Tahun' => $value->Tahun,
                                                                  'Kd_Urusan' => $value->Kd_Urusan,
                                                                  'Kd_Bidang' => $value->Kd_Bidang,
                                                                  'Kd_Unit' => $value->Kd_Unit,
                          ...
                          <?php if (Helper::checkRoute('pra-rka/ubah-rincian')) : ?>

                          <a href="#" title="ubah" class="ubah_rincian" value="<?= Url::to(['pra-rka/ubah-rincian',
                                                                  'Tahun' => $value->Tahun,
                                                                  'Kd_Urusan' => $value->Kd_Urusan,
                                                                  'Kd_Bidang' => $value->Kd_Bidang,
                                                                  'Kd_Unit' => $value->Kd_Unit,
