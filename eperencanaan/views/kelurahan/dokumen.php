...
<div class="ta-forum-lingkungan-media-index">
    <div class="row">
        <div class="col-md-12">
            <?= Html::a('Unduh Absensi', ['lingkungan/absensi', 'kode' => '2'], ['class' => 'btn btn-primary', 'target' => '_blank']) ?>
            ...
            <?php else : ?>
                <?= Html::a('Cetak Berita Acara', ['lingkungan/berita-acara', 'kode' => '2'], ['class' => 'btn btn-primary', 'target' => '_blank']) ?>
            <?php endif; ?>
        </div>
        <div class="col-md-12">
        ...
        ['class' => 'yii\grid\ActionColumn',
            ...
            'buttons' => [
                'edit1' => function ($url, $model) {
                    return Html::a('Download', ['sample-download',
                    ...
                    return Html::Button('Preview', ['class' => 'btn btn-info btn-sm',
                                'id' => 'preview',
                                'ext' => $model->kdMedia->Type_Media,
                                'data' => '@web/web/data/' . $model->kdMedia->Nm_Media, //'http://docs.google.com/gview?url=http://writing.engr.psu.edu/workbooks/formal_report_template.doc&embedded=true',
                                'data-toggle' => 'modal',
                                'data-target' => '#modal_lingkungan']);
                },
                    ],
                ],
            ],
