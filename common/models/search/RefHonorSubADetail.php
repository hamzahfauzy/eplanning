...
use common\models\RefHonorSubADetail as RefHonorSubADetailModel;

/**
 * RefHonorSubADetail represents the model behind the search form about `common\models\RefHonorSubADetail`.
 */
class RefHonorSubADetail extends RefHonorSubADetailModel
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = RefHonorSubADetailModel::find();
