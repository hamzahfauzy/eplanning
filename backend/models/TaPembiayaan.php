...
/**
 * This is the model class for table "Ta_Pembiayaan".
 *
 ...
 */
class TaPembiayaan extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * @inheritdoc
     * @return \backend\models\query\TaPembiayaanQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \backend\models\query\TaPembiayaanQuery(get_called_class());
    }
}
