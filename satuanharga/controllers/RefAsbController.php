...
class RefAsbController extends Controller
{
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
              ...
              //         $modelHspkAsb->Kd_Ssh5 = $value['Kd5'] ? $value['Kd5'] : 0;
              //         $modelHspkAsb->Kd_Ssh6 = $value['Kd6'] ? $value['Kd6'] : 0;
    ...
    public function actionUpdate($Kd_Asb1, $Kd_Asb2, $Kd_Asb3, $Kd_Asb4, $Kd_Asb5)
    {
        ...
        foreach ($datarincian as $value) {
            ...
            $Kategori_Pekerjaan_Nama = isset($value->kategoriPekerjaan->Uraian) ? $value->kategoriPekerjaan->Uraian : '-';
            ...
            $Uraian = isset($value->kdSsh2) ? $value->kdSsh2->Nama_Barang : '-';
            if($Asal == '2') {
                $Uraian= isset($value->kdHspk2) ? $value->kdHspk2->Uraian_Kegiatan : '-';
            }
            else if ($Asal == '3'){
                $Uraian = isset($value->kdAsb2) ? $value->kdAsb2->Jenis_Pekerjaan : '-';
            }
            ...
            try {
              ...
              if($request->isGet){
                  return [
                      ...
                      $models = TaHspkAsb::find()->where(['Kd_Asb1' => $Kd_Asb1, 'Kd_Asb2' => $Kd_Asb2, 'Kd_Asb3' => $Kd_Asb3, 'Kd_Asb4' => $Kd_Asb4, 'Kd_Asb5' => $Kd_Asb5])->all();
