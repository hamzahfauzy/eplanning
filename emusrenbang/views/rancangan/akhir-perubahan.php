...
$this->title = "Rancangan Akhir Renja Perangkat Daerah 2020-2021"; //.($tahun);
$this->params['breadcrumbs'][] = ['label' => 'Rancangan Akhir Perubahan', 'url' => ['rancangan/akhir-perubahan']];
            ...
            <div class="portlet box blue-hoki">
                    ...
                    <div class="control-wrap">
                        <div class="form-group">
                            <div class="col-sm-4">
								...
								<a href="index.php?r=laporan-skpd%2Fcetak-tvic10c"><button type="button" class="btn btn-warning btn-lg">Cetak</button></a>
                            </div>
                        </div>
						<div class="form-group">
                            <div class="col-sm-2">
                ...
                <div class="portlet-body">
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td></td>
                            <td style="font-size:12px;" align="right"> <?= number_format($belanja->sum('Total'),0, ',', '.') ?></td>
                            <td></td>
                            <td></td>
                            <td></td>
