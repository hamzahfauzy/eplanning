...
use backend\models\search\TaForumLingkunganMediaSearch;
...
class TaForumLingkunganMediaController extends Controller
{
    ...
    {   
        ...
        if($request->isAjax){
            ...
            return [
                    'title'=> "TaForumLingkunganMedia #".$id,
    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Create new TaForumLingkunganMedia",
                ...
                return [
                    ...
                    'title'=> "Create new TaForumLingkunganMedia",
                    'content'=>'<span class="text-success">Create TaForumLingkunganMedia success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
            ...
            */
            if ($model->load($request->post()) && $model->save()) {
                return $this->redirect(['view', 'id' => $model->Kd_Forum_Lingkungan]);
            } else {
    ...
    public function actionUpdate($id)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Update TaForumLingkunganMedia #".$id,
    ...
    /**
     * Delete an existing TaForumLingkunganMedia model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing TaForumLingkunganMedia model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    {
        if (($model = TaForumLingkunganMedia::findOne($id)) !== null) {
            return $model;
        } else {
