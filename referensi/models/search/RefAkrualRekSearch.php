...
/**
 * RefAkrualRekSearch represents the model behind the search form about `common\models\RefAkrualRek`.
 */
class RefAkrualRekSearch extends RefAkrualRek
{
    /**
     * @inheritdoc
     */
