...
use referensi\models\search\RefSumberDanaSearch;
...
class RefSumberDanaController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Create new RefSumberDana",
                ...
                return [
                    ...
                    'title'=> "Create new RefSumberDana",
                    'content'=>'<span class="text-success">Create RefSumberDana success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    /**
     * Delete an existing RefSumberDana model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing RefSumberDana model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
