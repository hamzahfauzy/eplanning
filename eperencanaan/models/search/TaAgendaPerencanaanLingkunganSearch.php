...
/**
 * TaAgendaPerencanaanLingkunganSearch represents the model behind the search form of `eperencanaan\models\TaAgendaPerencanaanLingkungan`.
 */
class TaAgendaPerencanaanLingkunganSearch extends TaAgendaPerencanaanLingkungan
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = TaAgendaPerencanaanLingkungan::find();
