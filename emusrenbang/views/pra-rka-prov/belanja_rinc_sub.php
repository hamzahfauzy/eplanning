    ...
    <div class="box box-success">
        <div class="box-body">
          ...
          <div class="col-md-12">
            ...
            <hr/>
             <?php
            if (Helper::checkRoute('pra-rka-prov/tambah-rincian-obyek')) : ?>
            <button type="button" class="btn btn-success pull-right" id="btn_tambah_rincian_obyek" 
                value="<?= Url::to(['pra-rka-prov/tambah-rincian-obyek',
                        'Tahun' => $data->Tahun,
                        'Kd_Urusan' => $data->Kd_Urusan,
                        'Kd_Bidang' => $data->Kd_Bidang,
                        'Kd_Unit' => $data->Kd_Unit,
                ...
                <?php
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                             <?php
                            if (Helper::checkRoute('pra-rka-prov/hapus-rincian-obyek')) : ?>
                              <a href="#" title="Hapus" class="hapus_obyek" data-tujuan="<?= Url::to(['pra-rka-prov/hapus-rincian-obyek',
                                                                  'Tahun' => $value->Tahun,
                                                                  'Kd_Urusan' => $value->Kd_Urusan,
                                                                  'Kd_Bidang' => $value->Kd_Bidang,
                                                                  'Kd_Unit' => $value->Kd_Unit,
                              ...
                              <?php endif;?>
                               <?php if (Helper::checkRoute('pra-rka-prov/ubah-rincian-obyek')) : ?>
                              <a href="#" title="Ubah" class="ubah_obyek" value="<?= Url::to(['pra-rka-prov/ubah-rincian-obyek',
                                                                  'Tahun' => $value->Tahun,
                                                                  'Kd_Urusan' => $value->Kd_Urusan,
                                                                  'Kd_Bidang' => $value->Kd_Bidang,
                                                                  'Kd_Unit' => $value->Kd_Unit,
